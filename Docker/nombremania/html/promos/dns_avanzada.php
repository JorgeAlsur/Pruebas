<?
 if ($_GET["affiliate_id"]<>"" or $_POST["affiliate_id"]<>""){
  ...
  $expira=time()+(45*24*60*60);   //45 dias de vencimiento de la cookiede afiliado
...
<TITLE>Dominio + DNS avanzada en NombreMania.com</TITLE>
<!-- #EndEditable --> 
  ...
  <tr> 
	...
	<!-- #BeginEditable "contenido" --> 
      <table width="710" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td width="180" valign="top" align="center"><!-- #BeginLibraryItem "/Library/banner180_ 2x.lbi" --><!--banner NMcajadoble de phpads -->
<iframe src='http://linux.alsur.es/phpads/adframe.php?what=zone:5&target=new&refresh=25' framespacing='0' frameborder='no' scrolling='no' width='180' height='150'><script language='JavaScript' src='http://linux.alsur.es/phpads/adjs.php?what=zone:5&target=new&withText=0'></script><noscript><a href='http://linux.alsur.es/phpads/adclick.php' target='new'><img src='http://linux.alsur.es/phpads/adview.php?what=zone:5&target=new&withText=0' border='0'></a></noscript></iframe><!-- #EndLibraryItem --><p><BR></p><!-- #BeginLibraryItem "/Library/Banner180.lbi" --><!--banner NMcaja de phpads -->
...
<!-- #EndLibraryItem --><p><BR>
          ...
          <td width="520" valign="top" class="body_10"> <SPAN class="body_titu">DNS 
            AVANZADA de NombreMania</SPAN><BR>
            Gestiona integramente la DNS de tu dominio
<HR color="orange">
            <FONT color="#990000"><BR>
            Un producto <B>&uacute;nico</B> de NombreMania pensado <B>para usuarios 
            avanzados e ideal para propietarios de l&iacute;neas dedicadas tipo 
            ADSL</B>.</FONT> 
            <P>Aunque es posible conectar &quot;servidores&quot; detr&aacute;s 
              de una conexi&oacute;n dedicada con IP fija (tipo ADSL), no es posible 
              usar esta misma IP como valores de DNS del registro. Adem&aacute;s 
              la DNS asociada a un dominio pueden ser el punto m&aacute;s cr&iacute;tico 
              de la misma pudiendo hacer que nada del dominio funcione si la misma 
              no esta operativa. (Ver <A href="http://www.nombremania.com/ayuda/pregun_dns.html" target="nueva">como 
              funciona una DNS</A> para m&aacute;s informaci&oacute;n.)</P>
            <P>La DNS AVANZADA es un sistema de gesti&oacute;n integral de la 
              DNS asociada a un dominio que podr&aacute;s gestionar via web dentro 
              del panel de control del propio dominio (ver secci&oacute;n <A href="http://www.nombremania.com/demos/manage/dns_avanzada.php" target="new">demo</A>), 
              de forma sencilla y r&aacute;pida. Los cambios se aplican casi de 
              forma instant&aacute;nea y te permitir&aacute;n:</P>
            <UL>
              <LI><B>Subdominios</B> <B>ilimitados*</B> (<B><FONT color="#990000">XXXX</FONT></B>.midominio.com) 
                <BR>
                Asociados a p&aacute;gina de parking o redirijidas a otra URL 
                cualquiera con o sin opci&oacute;n &quot;oculta&quot;.<BR>
                <BR>
              </LI>
              <LI><B>Redirecciones de correo electr&oacute;nico ilimitadas*</B>. 
                <BR>
                El correo enviado a <FONT color="#990000"><B>XXXX</B></FONT>@tudominio.com 
                se reenviar&aacute; a la direcci&oacute;n que indiques.<BR>
                <BR>
              </LI>
              <LI><B>Entradas tipo &quot;A&quot; ilimitadas*</B><BR>
                Son las entradas b&aacute;sicas que hacen operativa la web. Este 
                nombre a esta IP de un servidor. (<B><FONT color="#990000">XXXX</FONT></B>.midominio.com 
                asociado a la IP xxx.xxx.xxx.xx)<BR>
                <BR>
              </LI>
              <LI><B>Entradas &quot;MX&quot; </B><BR>
                Dirigen el correo de un dominio hacia un servidor. Te permitir&aacute; 
                gestionar tu/s propio/s servidor de correo si lo deseas, incluso 
                detr&aacute;s de un ADSL.<BR>
                <BR>
              </LI>
              <LI><B>Entradas &quot;CNAME&quot;<BR>
                </B>Son b&aacute;sicamente &quot;alias&quot; de otro nombre asociado 
                a una IP. Dos dominios distintos a un solo web.<B><BR>
                <BR>
                </B></LI>
              <LI><B>Balanceo de servidores<BR>
                </B>Para repartir carga o configurar dos servidores por si uno 
                de ellos deja de estar operativo.<B><BR>
                <BR>
                </B></LI>
              <LI><B>MX encandenados<BR>
                </B>Te permite poner en orden distintos servidores de correo (hasta 
                5) por si alguno deja de estar operativo.</LI>
            </UL>
            <P>Con este servicio y configurando correctamente tu router podr&aacute;s 
              asociar f&aacute;cilmente nombres tu conexi&oacute;n ADSL y distintos 
              servidores tras ella.</P>
            <P>&nbsp;</P>
            <P>&nbsp;</P>
            <P>&nbsp;</P>
            <P>&nbsp;</P>
            <P><B><I>*</I></B><I> Solo limitado por consumo total de la DNS en 
              tramos de 200 MB. (M&aacute;s de un millon de hits)</I></P>
            </td>
        </tr>
      </table>
      <br>
