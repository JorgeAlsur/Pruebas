    ...
    <table width="700" border="0" cellspacing="0" cellpadding="2">
      <tr>
        <td width="210" bgcolor="#000033" align="center">
          <div align="center"><font color="#FFFFFF"><b><font size="2">FACTURAS</font></b></font></div>
        </td>
...
//   if ($tipo!=""){
   $buscar=trim($buscar);
   $campos= " id,nombre,id_solicitud,concepto,DATE_FORMAT(FROM_UNIXTIME(fecha),'%d-%m-%y') as fecha2,nif,precio,CONCAT('<A HREF=ficha.php?id=',id_solicitud,'>solicitud</a>'),CONCAT('<A HREF=/clientes/pago/i_factura.php?id=',id,'>factura</a>')";
...
$t->parse("TAREAS_TIT","TAREAS_TIT");
    ...
    $cantidad++;
      ...
      $t->set_var("factura","<A HREF=/clientes/pago/i_factura.php?id={$rs->fields["id"]}>factura</a>");
if (!isset($sin_titulo))  $t->parse("TAREAS","TAREAS");
