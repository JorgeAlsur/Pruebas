  ...
  <table width="700" border="0" cellspacing="0" cellpadding="3">
    ...
    <tr> 
      <td align="center" bgcolor="#FFFFFF"><font size="2"><a href="clientes.php?tarea=inactivos"> 
        </a><a href="clientes.php?tarea=alta">Alta Manual ss</a> | <a href="clientes.php?tarea=inactivos">Consulta 
        inactivos/nuevos</a> | <a href="clientes.php?tarea=ver_todos">Ver todos 
        los clientes</a> | 
				<a href="clientesdistintos.php">Listado de clientes distintos (operaciones)</a></font>
				</td>
    </tr>
  </table>
</center>
