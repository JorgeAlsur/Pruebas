...
//print "id_cliente:".$_COOKIE["id_cliente"];
          ...
          <td width="520" valign="top"> <img src="/imagenes/titular_panelcontrol.gif" width="520" height="32">
            <table width="520" border="0" cellspacing="2" cellpadding="2">
              <tr> 
                ...
                <td bgcolor="#CCCCCC" width="5" class="body_10"></td>
            ...
            <table width="520" border="0" cellspacing="2" cellpadding="0">
              ...
              <tr>
                <td height="15" align="center"><IMG src="/imagenes/ico_down.gif" width="21" height="24"></td>
                <td colspan="2" height="15" valign="top"><FONT face="Verdana, Arial, Helvetica, sans-serif" size="1"><B class="body_11"><A href=/clientes/control/extracto.php>DETENER 
                  procesamiento de registros</A><BR>
                  </B>Esta acci&oacute;n detendr&aacute; el procesamiento autom&aacute;tico 
                  de registro, aunque exista saldo en tu cuenta.</FONT></td>
              </tr>
              <tr>
              ...
              <tr> 
                <td height="15" align="center">&nbsp;</td>
                <td colspan="2" height="20" valign="top"><font face="Verdana, Arial, Helvetica, sans-serif" size="1"><b class="body_11"><a href=/clientes/control/extracto.php>Extracto 
                  de operaciones</a>. </b><br>
                  &Uacute;ltimos movimientos de tu cuenta.</font></td>
              </tr>
              <tr> 
                <td height="15" align="center">&nbsp;</td>
                <td colspan="2" height="20" valign="top"><font face="Verdana, Arial, Helvetica, sans-serif" size="1"><b class="body_11"><a href=/clientes/control/dominios_registrados.php>Dominios 
                  registrados</a>.</b></font></td>
              </tr>
              <TR> 
                <TD height="15" align="center">&nbsp;</TD>
                <TD colspan="2" height="20" class="body_10" valign="top"> 
                  <P><FONT face="Verdana, Arial, Helvetica, sans-serif" size="1"><A href=/clientes/control/password.php><B class="body_11">Cambiar 
                    password de acceso</B></A></FONT></P>
                </TD>
              </TR>
              <TR> 
                <TD height="15" align="center">&nbsp;</TD>
                <TD colspan="2" height="20" class="body_10" valign="top"> 
                  <P><FONT face="Verdana, Arial, Helvetica, sans-serif" size="1"><A href=/clientes/control/email.php><B class="body_11">Cambiar 
                    email de contacto </B></A></FONT></P>
                </TD>
              </TR>
              <!--              <tr> 
                <td height="15" align="center">&nbsp;</td>
              ...
              <tr> 
                ...
                <td colspan="2" height="18"> 
                  ...
                  indicando como referencia tu n&uacute;mero de registrador<b>( 
                  <?=$id_cliente; ?>
                  ).<br>
