<?php 
include($DOCUMENT_ROOT."/classes/whois/server_list.php");
include($DOCUMENT_ROOT."/classes/whois/whois_class.php");
	...
	function create_dom_list() {
		if ($this->create_domain()) {
			if ($this->get_whois_data()) {
				$this->dom_str .= "The domain name: <b>".$this->compl_domain."</b> is registered.";
				$this->dom_str .= " <a href=\"multi_whois_detail.php?det=".$this->compl_domain."\" target=\"_blank\">Detail</a><br>\n";
			} else {
				$this->dom_str .= "The domain name: <b>".$this->compl_domain."</b> is free.<br>\n";
			}
		} else {
