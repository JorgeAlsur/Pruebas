          ...
          <td width="520" valign="top"><br>
            ...
            <table border="0" cellspacing="0" cellpadding="0" align="center">
              <tr align="left"> 
                <td class="body_10"> 
                  <div align="left"> 
                    <p><b><font face="Verdana, Arial, Helvetica, sans-serif" size="2" color="#CC0000" class="body_11">Gracias</font><font face="Verdana, Arial, Helvetica, sans-serif" size="3" color="#CC0000" class="body_11"> 
                      </font><font size="1" face="Verdana, Arial, Helvetica, sans-serif" color="red"></font><font face="Verdana, Arial, Helvetica, sans-serif" size="3" color="#CC0000"> 
                      </font></b></p>
                    <p><font face="Verdana, Arial, Helvetica, sans-serif" size="1">Su 
                      solicitud ha sido enviada correctamente.<br>
                      Estudiaremos su propuesta de registro del dominio <b> <font color="red"> 
                      <? echo $dominio?>
                      </font></b> y nos pondremos en contacto con usted a trav&eacute;s 
                      de email para concretar la forma de pago a fin de poder 
                      proceder con el registro si estimamos viable el mismo y 
                      todos los datos aportados son correctos.</font></p>
                  </div>
                </td>
              </tr>
            </table>
