                    ...
                    <tr> 
                        ...
                        <table border="0" cellpadding="4" bordercolor="#003399" cellspacing="0" width="100%">
                          <tr> 
                            <td width="48%" class="titu_secciones" height="12"><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><b><font size="1">Registro 
                              Est&aacute;ndar</font></b></font></td>
                          </tr>
                        </table>
                      ...
                      <td valign="top" width="250"> 
                        <table border="0" cellpadding="4" bordercolor="#003366" cellspacing="0" width="100%">
                          <tr> 
                            <td width="50%" class="body_10" height="12" bgcolor="#CCCCCC"><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><b><font size="1">Registro 
                              Pro </font></b></font></td>
                          </tr>
                        </table>
                        <table width="100%" border="0" cellspacing="0" cellpadding="4">
                          <tr> 
                            <td height="17"> 
                              <div align="center"><font face="Verdana, Arial, Helvetica, sans-serif" size="1"><i><font color="#666666"><br>
                                Las opciones de registro adicionales (PRO ) est&aacute;n 
                                deshabilitadas en el registro inicial de dominios 
                                .es. Podr&aacute; contratar estos servicios una 
                                vez se haya completado con &eacute;xito el proceso 
                                inicial.</font></i></font></div>
                            </td>
                          </tr>
                        </table>
                      </td>
                            ...
                            <td valign="top"> 
                              <form method="post" action="paso2.php" name="estandar">
                                <div align="center"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"> 
                                  <input type="hidden" name="Tipodedominio" value="Estandar">
