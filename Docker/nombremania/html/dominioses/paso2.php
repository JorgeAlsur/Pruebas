	...
	<!-- #BeginEditable "contenido" --> <br>
      <table width="710" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          ...
          <td width="520" valign="top"><font face="Verdana, Arial, Helvetica, sans-serif" size="1">&nbsp;</font> 
            <table width="520" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td height="18"><img src="/imagenes/titular_re_do_es2.gif" width="520" height="32"></td>
              </tr>
            </table>
            <table border="0" cellpadding="0" align="left" cellspacing="0" width="520">
              <tr> 
                <td>&nbsp;</td>
              </tr>
              <tr align="left"> 
                <td> 
                  <form method="post" action="paso3.php" name="dominioses" onSubmit="YY_checkform('dominioses','Organizacion','#q','0','Nombre Organizaci�n Completo','NIF','#q','0','NIF','Fechaconstitucion','#DD/MM/YYYY','3','Fecha constituci�n','Domicilio','#q','0','Domicilio','Municipio','#q','0','Municipio','CP','#1_999999','1','Cod. Postal','Provincia','#q','0','Provincia','Fechaconcesion','DD/MM/YYYY','3','Fecha de concesi�n');return document.MM_returnValue">
                    <font face="Verdana, Arial, Helvetica, sans-serif" size="1"><b><span class="body_11">DATOS 
                    SOBRE LA ORGANIZACI&Oacute;N O MARCA USUARIA DEL DOMINIO.</span><br>
                    <br>
                    </b></font> 
                    <table width="520" border="0" align="center">
                      <tr> 
                        <td nowrap bgcolor="#FFFFFF" height="16" class="td_form_titulo"><font size="1" face="Verdana, Arial, Helvetica, sans-serif">Tipo 
                          de dominio</font></td>
                        <td nowrap bgcolor="#FFCC00" height="16" class="td_form_valor"><font face="Verdana, Arial, Helvetica, sans-serif" size="2"> 
                          <?=$Tipodedominio;?>
                          </font></td>
                      <tr> 
                        <td nowrap bgcolor="#FFFFFF" class="td_form_titulo"> 
                          <div align="left"><font size="1" face="Verdana, Arial, Helvetica, sans-serif">Nombre 
                            ...
                            <input type="hidden" name="Tipodedominio" value="<? echo $Tipodedominio; ?>">
                      ...
                      <tr bgcolor="#000066"> 
                        <td nowrap colspan="2" height="15" class="titu_secciones"> 
                          <p><font face="Verdana, Arial, Helvetica, sans-serif" size="1" color="#FFFFFF"><b>Organizaci&oacute;n 
                            Usuaria del Nombre de</b></font></p>
                        </td>
                      </tr>
                      <tr> 
                        <td nowrap bgcolor="#FFFFFF" class="td_form_titulo"> 
                        ...
                        <td nowrap bgcolor="#FFCC00" class="td_form_valor"> 
                          <div align="left"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"> 
                            <input type="text" name="Organizacion" size="35" maxlength="256">
                            </font></div>
                        </td>
                      </tr>
                      <tr> 
                        <td bgcolor="#FFFFFF" class="td_form_titulo"> 
                          <div align="left"><font size="1" face="Verdana, Arial, Helvetica, sans-serif">Forma 
                            Jur&iacute;dica</font></div>
                        </td>
                        <td nowrap bgcolor="#FFCC00" class="td_form_valor"> 
                          <div align="left"> <font size="1" face="Verdana, Arial, Helvetica, sans-serif"> 
                            <select name="Formajuridica" size="1">
                              <option value="Sociedad An&oacute;nima" selected>Sociedad 
                              An&oacute;nima</option>
                              ...
                              <option value="Sociedad Agraria de Transformaci&oacute;n">Sociedad 
                              Agraria de Transformaci&oacute;n</option>
                              <option value="Sociedad An&oacute;nima Laboral">Sociedad 
                              An&oacute;nima Laboral</option>
                              <option value="Sociedad Laboral Limitada">Sociedad 
                              Laboral Limitada</option>
                              <option value="Sucursal en Espa&ntilde;a">Sucursal 
                              en Espa&ntilde;a</option>
                              <option value="Comunidad de Bienes">Comunidad de 
                              Bienes</option>
                              <option value="Comunidad de Propietarios">Comunidad 
                              de Propietarios</option>
                              <option value="Caja de Ahorros">Caja de Ahorros</option>
                              <option value="Fundaci&oacute;n">Fundaci&oacute;n</option>
                              <option value="Asociaci&oacute;n">Asociaci&oacute;n</option>
                              <option value="Asociaci&oacute;n Gremial">Asociaci&oacute;n 
                              Gremial</option>
                              <option value="Asociaci&oacute;n Deportiva">Asociaci&oacute;n 
                              Deportiva</option>
                              ...
                              <option value="Congregaci&oacute;n o Institucion Religiosa">Congregaci&oacute;n 
                              o Institucion Religiosa</option>
                              <option value="Organismo Aut&oacute;nomo no Estatal">Organismo 
                              Aut&oacute;nomo no Estatal</option>
                              <option value="Organismo Aut&oacute;nomo Estatal">Organismo 
                              Aut&oacute;nomo Estatal</option>
                              <option value="Corporaci&oacute;n Local">Corporaci&oacute;n 
                              Local</option>
                              <option value="Organo de la Administraci&oacute;n del Estado">Organo 
                              de la Administraci&oacute;n del Estado</option>
                              <option value="Organo de la Administraci&oacute;n Auton&oacute;mica">Organo 
                              de la Administraci&oacute;n Auton&oacute;mica</option>
                            </select>
                            </font></div>
                        </td>
                      </tr>
                      <tr> 
                        <td bgcolor="#FFFFFF" class="td_form_titulo"> 
                          <div align="left"><font size="1" face="Verdana, Arial, Helvetica, sans-serif">N.I.F.</font></div>
                        </td>
                        <td nowrap bgcolor="#FFCC00" class="td_form_valor"> 
                          <div align="left"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"> 
                            <input type="text" name="NIF" size="12" maxlength="10">
                            </font> <font face="Verdana, Arial, Helvetica, sans-serif" size="1">(Ej.: 
                            A60689551)</font></div>
                        </td>
                      </tr>
                      <tr> 
                        <td bgcolor="#FFFFFF" class="td_form_titulo"> 
                          <div align="left"><font size="1" face="Verdana, Arial, Helvetica, sans-serif">Fecha 
                            constituci&oacute;n</font></div>
                        </td>
                        <td nowrap bgcolor="#FFCC00" class="td_form_valor"> 
                          <div align="left"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"> 
                            <input type="text" name="Fechaconstitucion" size="12" maxlength="10">
                            (dd/mm/aaaa)</font></div>
                        </td>
                      </tr>
                      <tr> 
                        <td bgcolor="#FFFFFF" class="td_form_titulo"> 
                          <div align="left"><font size="1" face="Verdana, Arial, Helvetica, sans-serif">Domicilio</font></div>
                        </td>
                        <td nowrap bgcolor="#FFCC00" class="td_form_valor"> 
                          <div align="left"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"> 
                            <input type="text" name="Domicilio" size="35" maxlength="256">
                            </font></div>
                        </td>
                      </tr>
                      <tr> 
                        ...
                        <td nowrap bgcolor="#FFCC00" class="td_form_valor"> 
                          <div align="left"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"> 
                            <input type="text" name="Municipio" size="35" maxlength="50">
                            </font></div>
                        </td>
                      </tr>
                      <tr> 
                      ...
                      <tr> 
                        ...
                        <td nowrap bgcolor="#FFCC00" class="td_form_valor"> 
                          <div align="left"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"> 
                            <input type="text" name="Provincia" size="35" maxlength="50">
                            </font></div>
                        </td>
                      </tr>
                      <tr> 
                        <td bgcolor="#FFFFFF" class="td_form_titulo"> 
                          <div align="left"><font size="1" face="Verdana, Arial, Helvetica, sans-serif">Pa&iacute;s</font></div>
                        </td>
                        <td nowrap bgcolor="#FFCC00" class="td_form_valor"> 
                          <div align="left"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"> 
                      ...
                      <tr bgcolor="#000066"> 
                        <td nowrap colspan="2" height="15" class="titu_secciones"> 
                          <font face="Verdana, Arial, Helvetica, sans-serif" size="1" color="#FFFFFF"><b>Para 
                          nombre de dominio asociado a marca registrada</b></font></td>
                      </tr>
                      <tr> 
                        <td colspan="2" valign="top" class="body_10"> 
                          <p><font size="1" face="Verdana, Arial, Helvetica, sans-serif">Rellene 
                            esta secci&oacute;n cuando el nombre de dominio propuesto 
                            en la solicitud coincida literalmente con una marca 
                            o nombre comercial registrado a favor de de la organizaci&oacute;n 
                            en lugar de por asociaci&oacute;n con el nombre oficial 
                            de la organizaci&oacute;n especificado en el apartado 
                            anterior.</font></p>
                          <font face="Verdana, Arial, Helvetica, sans-serif" color="#CC0000" size="1"><b>ATENCION!! 
                          Si el nombre la organizaci&oacute;n no coincide exactamente 
                          con el dominio solicitado, este dato es imprescindible!!</b></font></td>
                      </tr>
                      <tr> 
                        <td bgcolor="#FFFFFF" class="td_form_titulo"> 
                          <div align="left"><font size="1" face="Verdana, Arial, Helvetica, sans-serif">Marca 
                            registrada en OEPM/OAMI</font></div>
                        </td>
                        <td nowrap bgcolor="#FFCC00" class="td_form_valor"> 
                          <div align="left"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"> 
                            <input type="text" name="Marca" size="35" maxlength="256">
                            </font></div>
                        </td>
                      </tr>
                      <tr> 
                        <td bgcolor="#FFFFFF" class="td_form_titulo"> 
                          <div align="left"><font size="1" face="Verdana, Arial, Helvetica, sans-serif">N&uacute;m. 
                            Inscripci&oacute;n en OEPM/OAMI</font></div>
                        </td>
                        <td nowrap bgcolor="#FFCC00" class="td_form_valor"> 
                          <div align="left"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"> 
                            <input type="text" name="Numero" size="30" maxlength="30">
                            </font></div>
                        </td>
                      </tr>
                      <tr> 
                        <td bgcolor="#FFFFFF" class="td_form_titulo"> 
                          <div align="left"><font size="1" face="Verdana, Arial, Helvetica, sans-serif">Fecha 
                            de Concesi&oacute;n</font></div>
                        </td>
                        <td nowrap bgcolor="#FFCC00" class="td_form_valor"> 
                          <div align="left"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"> 
                            <input type="text" name="Fechaconcesion" size="12" maxlength="10">
                            (dd/mm/aaaa) </font></div>
                        </td>
                      </tr>
                      <tr align="center"> 
