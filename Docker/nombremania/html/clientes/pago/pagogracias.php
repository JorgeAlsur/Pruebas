<?
  ...
  list($id_operacion,$p,$dominios,$usuario)=split(":",base64_decode($codigo));
    if ($usuario=="" or $id_operacion=="" or $dominios=="") {
     $error="Error de validacion, vuelva atr�s y reintente<hr>.$usuario -- $id_operacion -- $dominios";
...
<iframe src='http://linux.alsur.es/phpads/adframe.php?what=zone:5&target=new&refresh=25' framespacing='0' frameborder='no' scrolling='no' width='180' height='150'><script language='JavaScript' src='http://linux.alsur.es/phpads/adjs.php?what=zone:5&target=new&withText=0'></script><noscript><a href='http://linux.alsur.es/phpads/adclick.php' target='new'><img src='http://linux.alsur.es/phpads/adview.php?what=zone:5&target=new&withText=0' border='0'></a></noscript></iframe><!-- #EndLibraryItem --></td>
          ...
          <td width="520" valign="top"> 
            <table border=0 width="520" align="left" cellpadding="3">
              <tr> 
                <td colspan="3" height="20" class="titu_pags"><font face="Verdana, Arial, Helvetica, sans-serif" size="2">SOLICITUD 
                  DE PAGO A CARGO DE CUENTA DE CLIENTE REGISTRADO</font></td>
              </tr>
              <tr> 
                <td colspan="3" class="body_11"> 
                  <p><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><b><br>
                    <font color="#CC0000">GRACIAS.</font><br>
                    </b></font><font face="Verdana, Arial, Helvetica, sans-serif" size="2">Ha 
                    sido cargada con &eacute;xito en su cuenta de cliente la siguiente 
                ...
                <td colspan="3"> 
                  <table width="100%" border="0" cellspacing="2" cellpadding="2">
                    <tr> 
                      ...
                      <td width="68%" bgcolor="#FFFFFF" class="td_form_valor"><font face="Verdana, Arial, Helvetica, sans-serif" size="1"><b> 
                        <?=$nombre?>
                        </b></font></td>
                    </tr>
                    <tr> 
                      ...
                      <td width="68%" bgcolor="#FFFFFF" class="td_form_valor"><font face="Verdana, Arial, Helvetica, sans-serif" size="2"> 
                        <b> 
                        <?=$dominios?>
                        </b></font><b><font face="Verdana, Arial, Helvetica, sans-serif" size="1"></font></b></td>
                    </tr>
                    <tr> 
                      <td width="32%" bgcolor="#FFCC00" class="td_form_titulo"> 
              ...
              <tr> 
                <td colspan="3" class="body_10"><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><br>
                  En poco tiempo deber&iacute;a recibir un email a la direcci&oacute;n 
                  que indico al registrar el dominio, donde se le confirmar&aacute; 
                  la operaci&oacute;n.<br>
                  Gracias por usar NombreMania.com</font></td>
              </tr>
            </table>
          </td>
        </tr>
