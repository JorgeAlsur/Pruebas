...
else
{
	if(isset($nombre))
	{
		...
		$nombre=trim($nombre);
		$error='';
		$sql="select * from clientes where usuario='$nombre' and activo = 1;";
		$rs=$conn->execute($sql);
		//if($debug)echo $sql;
		if($conn->affected_rows()==0)
		{
			$error= "<p size=3>Usuario no Encontrado $nombre</p>";
		}
		else
		{
			if($rs->fields['clave']!=$clave)
			{
				$error ="<p size=3>Error en la clave ingresada. usuario $nombre</p>";
			}
		}
		$cod=base64_encode($nombre);
		if($error=='')
		{
			setcookie('id_cliente',$rs->fields('id'),time()+3600,"/");
			if(isset($volver) and $volver!='')
			{
				if($debug){echo "Entra. Location: $volver";exit;}
				header("Location: $volver");
			}
			else
			{
  ...
  <tr> 
	...
	<!-- #BeginEditable "contenido" --> 
      <table width="710" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td width="180" valign="top" height="380">&nbsp; </td>
          ...
          <td width="520" valign="top">
            <table border=0 width="520" align="left" cellpadding="3">
              <tr> 
                <td colspan="3"><img src="/imagenes/titular_acceso.gif" width="520" height="32"></td>
              </tr>
              <tr> 
                <td colspan="3" class="body_10"> 
                  <p><font face="Verdana, Arial, Helvetica, sans-serif" size="1"><b>Para 
                    clientes/afiliados previamente registrados. </b>Para m&aacute;s 
                    detalles sobre los descuentos y ventajas de ser cliente registrado 
                    o participar en nuestros programas para afiliados <a href="/afiliados.php" target="nueva">pulsa 
                    aqui</a>.</font></p>
                  <p><font face="Verdana, Arial, Helvetica, sans-serif" size="1"><b><font color="#990000">ATENCI&Oacute;N 
                    !! </font></b> Si lo que est&aacute;s intentando es acceder 
                    a la gesti&oacute;n de tus dominios accede por <a href="http://admin.nombremania.com">http://admin.nombremania.com</a></font></p>
                </td>
              </tr>
              <tr> 
                <td colspan="3"> 
                ...
                <td colspan="3" align="center"> 
                  <table border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr> 
                      ...
                      <td> 
                        <form action=<?=$PHP_SELF;?> method=get  name=login >
                          <table align=Center  border=0 cellspacing=1 cellpadding=1 width="100%">
                            <tr> 
                              <td colspan="3"> 
                                <input type=hidden name=clave_encriptada value="">
                                <font face="Verdana, Arial, Helvetica, sans-serif" size="1" color="#FF0000"> 
                                <?=$error; ?>
                                </font></td>
                            </tr>
                            <tr> 
                              <td align=right> <b><font face="Verdana, Arial, Helvetica, sans-serif" size="1">Usuario:</font> 
                                </b></td>
                              <td> 
                              ...
                              <td rowspan="2" align="right" valign="middle"> 
                                <input type=image src=/imagenes/continuar.gif name="image" width="85" height="26" >
                              </td>
                            </tr>
                            <tr> 
                            ...
                            <tr> 
                              <td bgcolor="#E6E6E6" colspan="3" class="body_10" align="center" ><a href="/clientes/control/perdio_password.php"><font face="Verdana, Arial, Helvetica, sans-serif" size="1">&iquest; 
                                Perdi&oacute; su password ? </font></a></td>
                            </tr>
                          </table>
                        </form>
                      </td>
