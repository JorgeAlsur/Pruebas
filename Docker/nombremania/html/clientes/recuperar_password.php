...
<body bgcolor="#ffcc00" onLoad="MM_preloadImages('/imagenes/base2/simbolo_f2.gif','/imagenes/base2/logo_f2.gif','/imagenes/base2/registrar_f2.gif','/imagenes/base2/Lineadeinfo_f3.gif','/imagenes/base2/trasladar_f2.gif','/imagenes/base2/Lineadeinfo_f4.gif','/imagenes/base2/administrar_f2.gif','/imagenes/base2/Lineadeinfo_f6.gif','/imagenes/base2/comprar_f2.gif','/imagenes/base2/Lineadeinfo_f5.gif','/imagenes/base2/alquiler_f2.gif','/imagenes/base2/Lineadeinfo_f8.gif','/imagenes/base2/demo_f2.gif','/imagenes/base2/Lineadeinfo_f7.gif','/imagenes/base2/precios_f2.gif','/imagenes/base2/afiliados_f2.gif','/imagenes/base2/ayuda_f2.gif','/imagenes/base2/whois_f2.gif','/imagenes/base3/simbolo_f2.gif','/imagenes/base3/logo_f2.gif','/imagenes/base3/registrar_f2.gif','/imagenes/base3/trasladar_f2.gif','/imagenes/base3/administrar_f2.gif','/imagenes/base3/comprar_f2.gif','/imagenes/base3/alquiler_f2.gif','/imagenes/base3/demo_f2.gif','/imagenes/base3/precios_f2.gif','/imagenes/base3/afiliados_f2.gif','/imagenes/base3/ayuda_f2.gif','/imagenes/base3/whois_f2.gif')"><!-- #BeginLibraryItem "/Library/nm2_navegador.lbi" --><table border="0" cellpadding="0" cellspacing="0" width="740" align="center">
  ...
  <tr> 
	...
	if (!isset($domain)){
        ?>
            <P style="background-color:#ffcc00;font-family: Verdana; font-weight:bold; font-size: 11pt;padding-left: 10px;">Recuperación de password de acceso al dominio</p>
              Seleccione el dominio para el que desea recuperar el password, las validaciones
              se realizan manualmente. Los datos de acceso serán enviados EXCLUSIVAMENTE
              al email registrado actualmente en el dominio. Consulte el WHOIS
              si tiene dudas.<br>
            <br><FONT face="Verdana, Arial, Helvetica, sans-serif" size="1" color="#FF0000"> 
              <?if ($errores<>"") echo $errores; ?>
              </FONT>
            <HR width=100% size="1" color="orange" noshade>
            <FORM method="post" action="<?=$PHP_SELF?>" name="rec" >
            <div align="right">&nbsp;Nombre
              del dominio para recuperar el password:
                <input name="domain" type="text" id="domain" size="40" maxlength="67">
                <p align="right"><input type="submit" name="Submit" value="Enviar"></p>
            </div>
            </FORM>
            <BR>
			<!--Devolucin si es correcto -->
			 ...
			 $link = "http://www.nombremania.com:8998/nmgestion/consultaoperaciones.php?buscar=$domain&tipo=dominio";
			  mail("soporte@nombremania.com","solicitud de password de acceso -  $domain","Recuperar password para $link  $domain");
             ?>
                  <table border=0 width="520" align="left" cellpadding="3">
                    <tr> 
                      <td colspan="3"><P style="background-color:#ffcc00;font-family: Verdana; font-weight:bold; font-size: 11pt;padding-left: 10px;">Gracias pronto recibirá un email con la información solicitada</p></td>
                    </tr>
                    <tr> 
                      <td colspan="3"> 
                        <p>&nbsp;</p>
                        <p><font size=2 face="Verdana, Arial, Helvetica, sans-serif" color="#000000"> 
                          <font size="1">Nos pondremos en contacto con usted con los detalles 
                          de acceso una vez aceptada su petici&oacute;n. Recuerde que esta comunicación se hará al email actualmente asociado al dominio.</font></font></p>
                      </td>
                    </tr>
                  </table>
