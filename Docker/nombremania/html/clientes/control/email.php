...
if (isset($viejo)){
    ...
    $sql="select email from clientes where id=$id_cliente";
    $rs=$conn->execute($sql);
        if ($rs===false){
          ...
          if ($rs->RecordCount()==0){
                 $error="El cliente no existe";
                    ...
                    if ($viejo<>$rs->Fields("email")){
                      $error="Error en el email anterior. Corrija y vuelva intentarlo.";
                      }
              include "String_Validation.inc.php";
              if (!is_email($nuevo)) {
                  $error="El nuevo Mail no es una direccion de correo valida";
              }
              else {
                  $sql="update clientes set email='$nuevo' where id=$id_cliente";
                  $rs=$conn->execute($sql);
                  if ($rs===false){
                          $error = "Error en el cambio de email en la base de datos.";
                  }
                  }
        }
    }
        ...
        <tr> 
          ...
          <td width="520" valign="top"><br>
            <table border=0 width="520" align="center" cellpadding="3">
              <tr> 
                <td colspan="3"><img src="/imagenes/titular_cambioemail.gif" width="520" height="32"></td>
              </tr>
              <tr> 
                <td colspan="3" class="body_10"><font size="1"><font face="Verdana, Arial, Helvetica, sans-serif" color="#000000">Este 
                  el email por defecto que se usar&aacute; para avisos de pago, 
                  notificaci&oacute;n de saldos, etc.</font></font></td>
              </tr>
              <tr> 
                <td colspan="3"> 
                ...
                <td colspan="3">
                  <table border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr> 
                      ...
                      <td class="body_10"> 
                        <form action="email.php" name="form1" onSubmit="YY_checkform('document.form1','nuevo','#q','2','Field \"nuevo\" is not valid.');return document.mm_returnvalue" >
                          <h3 align=center> <font color="#CC0000" face="Verdana, Arial, Helvetica, sans-serif" size="1"> 
                            <?=$error;?>
                            </font></h3>
                          <table width="100%" border="0" cellspacing="2" cellpadding="2" align="center">
                            <tr> 
                              ...
                              <td width="50%"> <font face="Verdana, Arial, Helvetica, sans-serif" size="1"> 
                                <input type="text" name="viejo" size="25" maxlength="50">
                                </font></td>
                            </tr>
                            <tr> 
                              <td width="50%"> 
                              ...
                              <td width="50%"><font face="Verdana, Arial, Helvetica, sans-serif" size="1"> 
                                <input type="text" name="nuevo" size="25" maxlength="50">
                                </font></td>
                            </tr>
                            <tr> 
                              <td width="50%"> 
                              ...
                              <td width="50%"> 
                                <div align="left"><font face="Verdana, Arial, Helvetica, sans-serif" size="1"> 
                                  <input name="imageField" type="image" src="/imagenes/enviar.gif" width="61" height="26" border="0">
                                </font></div>
                              </td>
                            </tr>
                          </table>
            ...
            <?
if ($error=="" and isset($viejo))
{
?>
            <p class="body_11"><font face="Verdana, Arial, Helvetica, sans-serif" size="+1"> 
              <font size="2">Cambio realizado con &eacute;xito.</font></font></p>
            <p><font face="Verdana, Arial, Helvetica, sans-serif" size="1" class="body_10"><a href=panel.php>Volver 
              al Panel de Control</a></font> 
              <?
}
