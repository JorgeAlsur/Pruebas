...
$sql="select clave from clientes where id=$id_cliente";
$rs=$conn->execute($sql);
if ($rs===false){
...
if ($vieja<>$rs->Fields("clave")){
$error="Error en la clave anterior. Corrija y vuelva intentarlo.";

}
if ($nueva<>$nueva2){
$error="Error en el ingreso de la nueva clave, las claves no coinciden, reintente";
}

if ($error==""){

$sql="update clientes set clave='$nueva' where id=$id_cliente";
$rs=$conn->execute($sql);
if ($rs===false){
    $error = "Error en el cambio de clave en la base de datos.";
}
      ...
      <table width="710" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          ...
          <td width="520" valign="top"> 
              <!--primera entrada y error -->
            <table border=0 width="520" align="center" cellpadding="3">
              <tr> 
                <td colspan="3"><img src="/imagenes/titular_cambioclave.gif" width="520" height="32"></td>
              </tr>
              <tr> 
                <td colspan="3"> 
                  <table border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr> 
                      ...
                      <td> 
                        <form name="form1" method=post onSubmit="YY_checkform('document.form1','vieja','#q','0','Field \"vieja\" is not valid.','nueva','#q','0','Field \"nueva\','nueva2"nueva2\');return document.MM_returnValue" >
                          <h3 align=center><font face="Verdana, Arial, Helvetica, sans-serif" size="1" color="red">
                            <?=$error;?></font>
                          </h3>
                          <table width="100%" border="0" cellspacing="2" cellpadding="2" align="center">
                            <tr> 
                              <td width="50%" class="body_10"> 
                                <div align="right"><b><font face="Verdana, Arial, Helvetica, sans-serif" size="1">Clave 
                                  actual:</font></b></div>
                              </td>
                              <td width="50%" class="body_10"> <font size="1" face="Verdana, Arial, Helvetica, sans-serif"> 
                                <input type="password" name="vieja" size="12" maxlength="8">
                                </font></td>
                            </tr>
                            <tr> 
                              <td width="50%" class="body_10"> 
                              ...
                              <td width="50%" class="body_10"><font face="Verdana, Arial, Helvetica, sans-serif" size="1"> 
                                <input type="password" name="nueva" size="12" maxlength="8">
                                </font></td>
                            </tr>
                            <tr> 
                              <td width="50%" class="body_10"> 
                                <div align="right"><b><font face="Verdana, Arial, Helvetica, sans-serif" size="1">Repita 
                                  clave:</font></b></div>
                              </td>
                              <td width="50%" class="body_10"><font face="Verdana, Arial, Helvetica, sans-serif" size="1"> 
                                <input type="password" name="nueva2" size="12" maxlength="8">
                                </font></td>
                            </tr>
                            <tr> 
                              <td width="50%">&nbsp; </td>
                              <td width="50%" align="right"> <font face="Verdana, Arial, Helvetica, sans-serif"> 
                  ...
                  <a href=panel.php><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><font size="1"><span class="body_10"><br>
                  &nbsp; Volver al Panel de Control</span></font></font></a></td>
              </tr>
            </table>
              <!--operacion realizada (redirigir a panel?)
-->
            <?
        if ($error=="" and isset($vieja))
        { //se actualizo correctamente
?>
            <table border=0 width="520" align="center" cellpadding="3">
              <tr> 
                <td colspan="3" class="body_11"><b><font size="1" face="Verdana, Arial, Helvetica, sans-serif">Su 
                  password de acceso ha sido modificado.</font></b></td>
              </tr>
            </table>
            <?
}
