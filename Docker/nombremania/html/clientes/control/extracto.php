...
$sql="select id,DATE_format(fecha,\"%d-%m-%Y\") as fecha2, tipo, importe, mid(observacion,1,45) as observacion   from transacciones where id_cliente=$id_cliente order by fecha";
$rs=$conn->execute($sql);
  ...
  <tr> 
    ...
    <td colspan="23" height="150" bgcolor="#FFFFFF" valign="top"><br>
      ...
      <center>
            ...
            <TABLE width=520 align=center border="0" bordercolor="#000000">
              <tr> 
                <td colspan="4"><img src="/imagenes/titular_extracto.gif" width="520" height="32"></td>
              </tr>
              <tr> 
                <td colspan="3" class="td_form_titulo"> 
                  <div align="right"><b><font face="Verdana, Arial, Helvetica, sans-serif" size="2">Saldo 
                    Actual:</font></b> <b><font face="Verdana, Arial, Helvetica, sans-serif" size="2" color="#CC0000"> 
                    </font></b></div>
                </td>
                <td class="td_form_valor2"><b><font face="Verdana, Arial, Helvetica, sans-serif" size="1" color="#CC0000"> 
                  <?=$rs2->fields('saldo')?>
                  </font> <font face="Verdana, Arial, Helvetica, sans-serif" size="1" color="#CC0000"> 
                  Euros. </font></b></td>
              </tr>
              <tr> 
                <td bgcolor="#FFCC00" class="td_form_valor"><b><font face="Verdana, Arial, Helvetica, sans-serif" size="1">Fecha</font></b></td>
                <td align="center" bgcolor="#FFCC00" class="td_form_valor"><b><font face="Verdana, Arial, Helvetica, sans-serif" size="1">Debe/Haber</font></b></td>
                <td bgcolor="#FFCC00" class="td_form_valor"><b><font face="Verdana, Arial, Helvetica, sans-serif" size="1">Concepto</font></b></td>
                <td bgcolor="#FFCC00" class="td_form_valor"><b><font face="Verdana, Arial, Helvetica, sans-serif" size="1">Importe 
                  </font></b></td>
              </tr>
              <caption>&nbsp; </caption>
              <?
...
?>
              <tr> 
                <td bgcolor="#FFFFFF" class="body_10"> <font face="Verdana, Arial, Helvetica, sans-serif" size="1"> 
                  <?=$rs->fields('fecha2')?>
                  </font></td>
                <td align="center" bgcolor="#FFFFFF" class="body_10"> <font face="Verdana, Arial, Helvetica, sans-serif" size="1"> 
                  <? echo ($rs->fields('tipo') == 'c') ? "cr&eacute;dito" : "d&eacute;bito"; ?>
                  </font> </td>
                <td bgcolor="#FFFFFF" class="body_10"> <font face="Verdana, Arial, Helvetica, sans-serif" size="1"> 
                  <?=$rs->fields("observacion");?>
                  </font></td>
                <td bgcolor="#FFFFFF" class="body_10"> <font face="Verdana, Arial, Helvetica, sans-serif" size="1"> 
...
$rs->MoveNext();
  ...
  ?>
            </TABLE>      <p align="center" class="body_10"><a href=panel.php><font face="Verdana, Arial, Helvetica, sans-serif" size="1">Volver 
              al Panel de Control</font></a><font face="Verdana, Arial, Helvetica, sans-serif" size="1"><br>
              <br>
              <br>
              <br>
              <br>
