...
$color_sin_liquidar='#FFCCCC';
$color_liquidado='#EEF5DA';

$sql="select * from clientes where id = $id_cliente";
$rs=$conn->execute($sql);
$op_liquidadas=$rs->fields['op_liquidadas'];
unset($rs);
//$sql="select id,date_format(from_unixtime(fecha),\"%d-%m-%Y\") as fecha ,dominio,period,precio,comision, porc_comision from dominios where affiliate_id=$id_cliente order by fecha DESC" ;

if(!isset($orden))
{
	$orden=' fecha ASC';
}
$sql="select id,date_format(from_unixtime(fecha),\"%d-%m-%Y\") as fecha2 ,fecha, domain as dominio, period, comision, porc_comision, precio from operaciones where affiliate_id=$id_cliente order by $orden";
//if($debug)echo $sql;
$rs=$conn->execute($sql);
//rs2html($rs);
?>
    ...
    <td colspan="23" height="150" bgcolor="#FFFFFF" valign="top"><br>
      ...
      <table width="710" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="520" valign="top" height="300"> 
            <center>
      </center>
            <TABLE align="center" border="0" bordercolor="#000000">
              <tr> 
                <td colspan="6"><img src="/imagenes/titulo_D_registrado.gif" width="520" height="32"></td>
              </tr>
              <tr> 
                <td bgcolor="#FFCC00" class="td_form_valor" height="13"><b><font face="Verdana, Arial, Helvetica, sans-serif" size="1">Fecha</font></b></td>
                <td align="left" bgcolor="#FFCC00" class="td_form_valor" height="13"><b><font face="Verdana, Arial, Helvetica, sans-serif" size="1">Dominios</font></b></td>
                <td bgcolor="#FFCC00" class="td_form_valor" height="13" align="center"><b><FONT face="Verdana, Arial, Helvetica, sans-serif" size="1">A&ntilde;os</FONT></b></td>
                <TD align="right" class="td_form_valor" height="13"><B><FONT face="Verdana, Arial, Helvetica, sans-serif" size="1">PVP</FONT></B></TD>
                <TD bgcolor="#FFCC00" class="td_form_valor" align="center" height="13"><FONT face="Verdana, Arial, Helvetica, sans-serif" size="1"><B>%</B></FONT></TD>
                <TD bgcolor="#FFCC00" class="td_form_valor" align="right" height="13"><B><FONT face="Verdana, Arial, Helvetica, sans-serif" size="1">Comisi&oacute;n</FONT></B></TD>
              </tr>
              <?
$totalnoliquidadas=0;$totalliquidadas=0;
while(!$rs->EOF)
{
	if($rs->fields['id']<=$op_liquidadas)
	{
		$totalliquidadas+=$rs->fields['comision'];
		$bgcolor=$color_liquidado;
	}
	else
	{
		$totalnoliquidadas+=$rs->fields['comision'];
		$bgcolor=$color_sin_liquidar;
	}
	$tmp_dominio=str_replace('**',' ** ',$rs->fields['dominio']);
?>
              <tr> 
                <td class="body_10"> <font face="Verdana, Arial, Helvetica, sans-serif" size="1"> 
                  <?=$rs->fields('fecha2')?>
                  </font></td>
                <td align="left" class="body_10"> <font face="Verdana, Arial, Helvetica, sans-serif" size="1"> 
                  <?=$tmp_dominio?>
                  </font> </td>
                <td class="body_10" align="center"> <font face="Verdana, Arial, Helvetica, sans-serif" size="1"> 
                  <?=$rs->fields('period')?>
                  </font></td>
                <TD align="right" class="body_10"><?=number_format($rs->fields('precio'),2); ?></TD>
                <TD bgcolor="<?=$bgcolor?>" class="body_10" align="center"><?=number_format($rs->fields["porc_comision"])?></TD>
                <TD bgcolor="<?=$bgcolor?>" class="body_10" align="right"><B><?=number_format($rs->fields["comision"],2)?></B></TD>
              </tr>
              <?
$rs->MoveNext();
}
  ?>
              ...
              <tr> 
                <td class="body_10" colspan="6">&nbsp;</td>
              </tr>
              <tr> 
                <td class="body_10" height="17">&nbsp;</td>
                <td align="left" class="body_10" height="17">&nbsp;</td>
                <td class="body_10" align="center" height="17">&nbsp;</td>
                <TD align="right" class="body_10" height="17" colspan="2"><FONT face="Verdana, Arial, Helvetica, sans-serif" size="1">Comisiones</FONT><B><FONT face="Verdana, Arial, Helvetica, sans-serif" size="1"> 
                  liquidadas</FONT></B></TD>
                <TD bgcolor="<?=$color_liquidado?>" class="body_10" align="right" height="17"><B><FONT color="#990000"><?=number_format($totalliquidadas,2)?></FONT></B></TD>
              </tr>
              <tr> 
                <td class="body_10">&nbsp;</td>
                <td align="left" class="body_10">&nbsp;</td>
                <td class="body_10" align="center">&nbsp;</td>
                <TD align="right" class="body_10" colspan="2"><FONT face="Verdana, Arial, Helvetica, sans-serif" size="1">Comisiones</FONT><B><FONT face="Verdana, Arial, Helvetica, sans-serif" size="1"> 
                  por liquidar</FONT></B></TD>
                <TD bgcolor="<?=$color_sin_liquidar?>" class="body_10" align="right"><FONT color="#003300"><B><?=number_format($totalnoliquidadas,2)?></B></FONT></TD>
              </tr>

            </TABLE>
            <p align="center" class="body_10"><a href="panel.php"><font face="Verdana, Arial, Helvetica, sans-serif" size="1"><BR>
              Volver al Panel de Control</font></a><font face="Verdana, Arial, Helvetica, sans-serif" size="1"><br>
              <br>
              <br>
              </font> 
          </td>
  ...
  <tr>
    <td colspan="23" bgcolor="#FFFFFF" valign="bottom"><!-- #BeginEditable "Pie de pgina" --><!-- #EndEditable --><!-- #BeginLibraryItem "/Library/nm2_pie_generico.lbi" --><table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr> 
