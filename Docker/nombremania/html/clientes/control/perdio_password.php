...
$sql="select id,email,clave from clientes where email='$f_email'";
$rs=$conn->execute($sql);
$error="";
if ($rs===false){
...
if ($rs->RecordCount()==0){
$error= "No esta ingresado como cliente de Nombremania. ";
}
...
if ($error==""){ //no existen errorres
   $p= mail($email,"Password Cliente/afiliado Nombremania","Su password de acceso de clientes en Nombremania es $clave","From: registros@nombremania.com");
   if (!$p) echo "error en el envio del mail ";
}
}
      ...
      <table width="710" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          ...
          <td width="520" valign="top"><br>
            <!--contenido para entrada y error-->
            <table border=0 width="520" align="center" cellpadding="3">
              <tr> 
                <td colspan="3"><img src="/imagenes/titular_recuperardatos.gif" width="520" height="32"></td>
              </tr>
              <tr> 
                <td colspan="3" class="body_10"> 
                  <p><font face="Verdana, Arial, Helvetica, sans-serif" size="1" color="#000000">Si 
                    ha olvidado su password, introduzca el email asociado a su 
                    cuenta de cliente registrado y le remitiremos un email con 
                    los detalles de la misma.</font></p>
                  <p><font face="Verdana, Arial, Helvetica, sans-serif" size="1" color="#000000">Recuerde
                       que estos datos son solo validos para su cuenta de cliente
                       en NombreMania, no para la administraci&oacute;n de sus
                       dominios,  asociados a los distintos perfiles con los
                       que fueran registrados. -- </font></p>
                </td>
              </tr>
              <tr> 
                <td colspan="3"> 
                ...
                <td colspan="3"> 
                  <table border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="250" background="/imagenes/marco/mea.gif"><img name="mea" src="/imagenes/marco/mea.gif" width="82" height="9" border="0"></td>
                    ...
                    <tr> 
                      ...
                      <td> 
                        <form action="<?=$PHP_SELF?>" method=post name="form" onSubmit="YY_checkform('form','f_email','S','2','email no valido');return document.MM_returnValue"f_usuario\" is not valid.','f_email','q','2','Field \"f_email\');return document.MM_returnValue" >
                          <h3 align=center><font face="Verdana, Arial, Helvetica, sans-serif" size="1" color="#FF0000"> 
                            <?=$error;?></font>
                          </h3>
                        <table width="100%" border="0" align="center" cellpadding="2" cellspacing="0">
                            <tr valign="bottom"> 
                              <td class="body_10"><font face="Verdana, Arial, Helvetica, sans-serif" size="1"><b>Email 
                                de su cuenta:</b></font><font face="Verdana, Arial, Helvetica, sans-serif"></font></td>
                            </tr>
                            <tr valign="bottom"> 
                              <td><font face="Verdana, Arial, Helvetica, sans-serif"> 
                                <input type="text" id="f_email" name="f_email" size="25" maxlength="50">
                                <input type="image" border="0" name="Enviar" src="/imagenes/enviar.gif">
</font></td>
                            </tr>
                          </table>
                        </form>
            ...
            <p> 
              <!--contenido para ejecucion correcta

 -->
            <?
  if (isset($f_email) and $error=="") {
?>
            <table border=0 width="520" align="center" cellpadding="3">
              <tr> 
                <td colspan="3" class="body_11"> 
                  <p><font face="Verdana, Arial, Helvetica, sans-serif" size="1" color="#000000"><b>Gracias.<br>
                    Le ha sido enviado un email con los detalles de acceso a su 
                    cuenta</b></font>
                </td>
              </tr>
            </table>
