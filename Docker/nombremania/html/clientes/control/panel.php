...
if(!$id_cliente) $id_cliente = $_COOKIE['id_cliente'];
$conn->debug=0;
$sql = "select * from clientes where id=$id_cliente";
$rs=$conn->execute($sql);
if(!$rs){
	mail("jose@alsur.es","Error en nm",$sql.' *** '.print_r($_REQUEST, true),"From: Debug System <sistemas@alsur.es>\nContent-type: text/html");
}
$email=$rs->fields("email");
$rs2=$conn->execute("select sum(importe) as saldo from transacciones where id_cliente=$id_cliente");

//print "id_cliente:".$HTTP_COOKIE_VARS["id_cliente"];

?>
<HTML><!-- #BeginTemplate "/Templates/nm2_solophp.dwt" -->
<HEAD>
<meta http-equiv="Content-type" content="text/html; charset=UTF-8">
<!-- #BeginEditable "doctitle" -->
<TITLE>Nombremania - Panel de Control Afiliados</TITLE>
<!-- #EndEditable --> 
...
?>
              ...
              <tr> 
                ...
                <td> 
                  <table border="0" cellpadding="4">
                    <tr> 
                      <td colspan="2" valign="bottom" class="body_10"><font face="Verdana, Arial, Helvetica, sans-serif" size="1"><b>REGISTRAR</b></font></td>
                    </tr>
                    <tr> 
                      <td colspan="2" valign="bottom" class="body_10"> 
                        <form method="post" action="/dominator.php" name="registrar">
                    ...
                    <tr> 
                      <td colspan="2"> 
                        <input type="image" border="0" name="Buscar..." src="/imagenes/buscar.gif" width="68" height="26">
												 </form>
                      </td>
                    </tr>
                    <tr> 
                      <td colspan="2" class="body_10"><font face="Verdana, Arial, Helvetica, sans-serif" size="1"><a href="/registrar.php">Registro 
                        por lotes</a> (varios dominios en una sola orden)</font></td>
                    </tr>
                  </table>
                </td>
                <td background="/imagenes/marco/dem.gif" width="9"><img name="dem" src="/imagenes/marco/dem.gif" width="9" height="43" border="0"></td>
              ...
              <tr> 
                ...
                <td> 
                  <table border="0" cellspacing="0" cellpadding="4">
                    <tr> 
                      <td colspan="2" class="body_10" align="center"><font face="Verdana, Arial, Helvetica, sans-serif" size="1"><b>TRASLADAR 
                        UN DOMINIO</b></font></td>
                    </tr>
                    <tr> 
                      <td colspan="2" class="body_10" valign="bottom"> 
                        <form method="post" action="/dominator.php" name="trasladar">
                          <input type="hidden" name="affiliate_id" value="<?=$id_cliente;?>">
                          <input type="hidden" name="action" value="check_transfer">
                          <input type="text" name="domain" size="15">
                          <input type="image" border="0" name="Buscar..." src="/imagenes/buscar.gif" width="68" height="26">
                        </form>
                      </td>
                    ...
                    <tr> 
                      <td colspan="2" class="body_10"><font face="Verdana, Arial, Helvetica, sans-serif" size="1"><a href="/trasladar.php">Traslado 
                        por lotes</a> (varios dominios en una sola orden)</font></td>
                    </tr>
                  </table>
                </td>
            ...
            <hr width=100% size="1" color="orange"></table><!-- #EndEditable --></tr></table><!-- #BeginLibraryItem "/Library/Banner180.lbi" --><!--banner NMcaja de phpads -->
...
<!-- #EndLibraryItem --><table bgcolor="#ffcc00" border="0" cellpadding="0" cellspacing="0" width="740" align="center"><tr><!-- #BeginEditable "contenido" --><table width="710" border="0" cellspacing="0" cellpadding="0"><tr><div align="left"> 
              <p> 
              
            </div>
          </td>
          <td width="10" valign="top"><img src="/imagenes/base2/spacer.gif" width="10" height="8" border="0"></td>
          <td width="520" valign="top"> <img src="/imagenes/titular_panelcontrol.gif" width="520" height="32">
            <table width="520" border="0" cellspacing="2" cellpadding="2">
              <tr> 
                <td bgcolor="#F0F0F0" height="15" width="90" align="center" class="td_form_titulo"> 
                  <div align="right"><font face="Verdana, Arial, Helvetica, sans-serif" size="1">ID 
                    : </font></div>
                </td>
                <td bgcolor="#CCCCCC" width="5" class="body_10"><font face="Verdana, Arial, Helvetica, sans-serif" size="1"></font></td>
                <td bgcolor="#CCCCCC" class="body_10"><font face="Verdana, Arial, Helvetica, sans-serif" size="1"> 
                  <?=$id_cliente; ?>
                  </font></td>
              </tr>
              <tr> 
                <td bgcolor="#F0F0F0" height="15" width="90" align="center" class="td_form_titulo"> 
                  <div align="right"><font face="Verdana, Arial, Helvetica, sans-serif" size="1">Cliente 
                    : </font></div>
                </td>
                <td width="5" height="18" bgcolor="#CCCCCC" class="body_10"><font color="#CCCCCC" face="Verdana, Arial, Helvetica, sans-serif" size="1"></font></td>
                <td height="18" bgcolor="#CCCCCC" class="body_10"><font face="Verdana, Arial, Helvetica, sans-serif" size="1"><b> 
                  <?=$rs->Fields("nombre");?>
                  </b> </font></td>
              </tr>
              <tr> 
                ...
                <td width="5" height="18" bgcolor="#CCCCCC" class="body_10"><font color="#CCCCCC" face="Verdana, Arial, Helvetica, sans-serif" size="1"></font></td>
                <td height="18" bgcolor="#CCCCCC" class="body_10"><font face="Verdana, Arial, Helvetica, sans-serif" size="1"> 
                  <?=$email;?>
                  </font></td>
              </tr>
              <tr> 
              ...
              <tr> 
                ...
                <td colspan="2" height="40" class="body_10" valign="top"> 
                  <p><font face="Verdana, Arial, Helvetica, sans-serif" size="1"><a href=password.php><b class="body_11">Cambiar 
                    password de acceso<br>
                    </b></a>Recuerda que solo afectar&aacute; a tu panel de control 
                    de clientes, no a la administraci&oacute;n de dominios.</font></p>
                  </td>
              </tr>
              <tr> 
                <td height="15" align="center">&nbsp;</td>
                <td colspan="2" height="40" class="body_10" valign="top"> 
                  <p><font face="Verdana, Arial, Helvetica, sans-serif" size="1"><a href=email.php><b class="body_11">Cambiar 
                    email de contacto </b></a><br>
                    Te permite cambiar la direcci&oacute;n a la que se enviar&aacute;n 
                    las confirmaciones de autorizaci&oacute;n de pagos para registro 
                    de dominios.</font></p>
                </td>
              </tr>
              <tr> 
                <td height="15" align="center">&nbsp;</td>
                <td colspan="2" height="40" valign="top"><font face="Verdana, Arial, Helvetica, sans-serif" size="1"><a href=opciones_afiliado.php?id_cliente=<?=$id_cliente?>><b class="body_11">Programa 
                  de afiliados</b></a></font><span class="body_10"><font face="Verdana, Arial, Helvetica, sans-serif" size="1"><br>
                  Banners y codigos HTML personalizados para incluir en tu p&aacute;gina 
                  web y obtener creditos adicionales como afiliado.</font></span></td>
              </tr>
            </table>
            <br>
            <table width="520" border="0" cellspacing="2" cellpadding="0">
              <tr> 
                <td bgcolor="#FFFFFF" height="15" width="90" align="center" class="td_form_titulo"> 
                  <div align="right"><font face="Verdana, Arial, Helvetica, sans-serif" size="1">Saldo 
                    actual : </font></div>
                </td>
                <td bgcolor="#FFFFFF" width="5" class="td_form_valor2">&nbsp;</td>
                <td bgcolor="#CCCCCC" class="td_form_valor2"> <font face="Verdana, Arial, Helvetica, sans-serif" size="2" color="#FF0000"> 
								&euro; <?=$rs2->Fields("saldo");?>
                  </font></td>
              </tr>
              <tr> 
              ...
              <tr> 
                <td height="15" align="center">&nbsp;</td>
                <td colspan="2" height="40" valign="top"><font face="Verdana, Arial, Helvetica, sans-serif" size="1"><b class="body_11"><a href=extracto.php>Extracto 
                  de operaciones</a>. </b><br>
                  Te permite consultar los &uacute;ltimos movimientos de tu cuenta, 
                  bonificaciones, pagos, dominios cargados en cuenta, etc.</font></td>
              </tr>
              <tr> 
                <td height="15" align="center">&nbsp;</td>
                <td colspan="2" height="40" valign="top"><font face="Verdana, Arial, Helvetica, sans-serif" size="1"><b class="body_11"><a href=dominios_registrados.php>Dominios 
                  registrados</a>. </b><br>
                  Te permite consultar los &uacute;ltimos movimientos de tu cuenta, 
                  bonificaciones, pagos, dominios cargados en cuenta, etc.</font></td>
              </tr>
<!--              <tr> 
                <td height="15" align="center">&nbsp;</td>
                <td colspan="2" height="40" valign="top"><font face="Verdana, Arial, Helvetica, sans-serif" size="1"><b class="body_11"><a href=lista_venta_alquiler.php>Dominio 
                  en Venta/Alquiler</a> </b><br>
                  Podr&aacute;s consultar los dominios tuyos o de tus clientes, 
                  actualmente ofertados.</font></td>
              </tr> -->
              <tr> 
                <td height="15" align="center">&nbsp;</td>
                <td colspan="2" height="18"> 
                  <hr width=100% size="1" color="orange">
                  <font face="Verdana, Arial, Helvetica, sans-serif" size="1"><b>TRANSFERENCIAS</b><br>
                  Puedes realizar nuevos pagos mediante transferencia bancar&iacute;a 
                  a:</font> <font face="Verdana, Arial, Helvetica, sans-serif" size="1"><b> 
                  <br>
                  NombreMania - El sur existe s.l.</b><br>
                  CCC: <b>ES1900495009012116041702</b><br>
                  indicando como referencia tu n&uacute;mero de afiliado<b> ( 
                  <?=$id_cliente; ?>
                  ).<br>
                  </b>Para acelerar el abono en cuenta envianos copia del resguardo 
                  de la operaci&oacute;n por fax al n&uacute;mero <b>+34 95 258-8246</b> 
                  o rellena nuestro <a href="/pago_transferencia.php">formulario 
                  de aviso</a> de transferencia.</font></td>
              </tr>
            </table>
            <br>
          </td>
  ...
  <tr> 
    <td colspan="23" bgcolor="#FFFFFF" valign="bottom"><!-- #BeginEditable "Pie de p�gina" --><!-- #EndEditable --><!-- #BeginLibraryItem "/Library/nm2_pie_generico.lbi" --><table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr> 
