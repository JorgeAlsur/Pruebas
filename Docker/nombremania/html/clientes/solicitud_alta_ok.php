      ...
      <table width="710" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          ...
          <td width="520" valign="top">
            <table border=0 cellpadding="3" width="520">
              <?
          $fatal=0;
          $error=array();
          $errores="";
...
if (!envioemail($ruta."/procesos/mails_a_enviar/mail_afiliado_aceptacion.txt",$dat)){
    ...
    exit;
        ...
        ?>
              ...
              <tr> 
                <td colspan="3" class="body_10">Rellena todos los campos del siguiente 
                  formulario con tus datos y nos pondremos en contacto con los 
                  detalles de acceso una vez aceptada tu solicitud.</td>
              </tr>
              <tr> 
              ...
              value="<?=$f_fax; ?>" size="30">
                      ...
                      <tr> 
                        <td bgcolor="#FFFFFF" colspan="3" class="body_10"><font face="Verdana, Arial, Helvetica, sans-serif" size="1">Introduzca 
                          un login y password que le resulten familiares para 
                          acceder posteriormente a su panel de control de afiliado. 
                          <b>Le recomendamos utilizar la misma clave y usuario 
                          con la que registra habitualmente sus dominios.</b></font></td>
                      </tr>
                      <tr> 
                        <td bgcolor="#FFFFFF" class="td_form_titulo"> 
                          <div align="right"><font face="Verdana, Arial, Helvetica, sans-serif" size="1">Nombre 
                      ...
                      <tr> 
                        <td bgcolor="#FFFFFF" colspan="3" class="body_10"><font face="Verdana, Arial, Helvetica, sans-serif" size="1">Aunque 
                          son opcionales, nos ayudar&iacute;a mucho conocer su 
                      ...
                      <tr> 
                        <td bgcolor="#FFFFFF" valign="middle" class="td_form_titulo" align="right"><FONT face="Verdana, Arial, Helvetica, sans-serif" size="1">&iquest;Tienes 
                          intenci&oacute;n de participar en nuestro programa de 
                          afiliados, mediante publicidad de NombreMania en tu 
                          site/s?:</FONT></td>
                        <td colspan="2" bgcolor="#FFCC00" class="td_form_valor"> 
                      ...
                      <tr> 
                        <td bgcolor="#FFFFFF" valign="top" class="td_form_titulo" height="149"> 
                          <div align="right"><font face="Verdana, Arial, Helvetica, sans-serif" size="1">Condiciones:</font></div>
                        </td>
                        <td colspan="2" bgcolor="#FFCC00" class="td_form_valor" height="149"> 
                          <p> <font face="Verdana, Arial, Helvetica, sans-serif" size="1"> 
                            <textarea name="condiciones" cols="40" rows="6" wrap="VIRTUAL">CONDICIONES DE AFILIACI&Oacute;N
1.- El interesado que cumplimenta este formulario (desde ahora el afiliado) desea 
convertirse en &quot;cliente registrado&quot; del programa de afiliaci&oacute;n 
de NombreMania.com y ha le&iacute;do y entiende todas las condiciones y obligaciones 
que ello conlleva.
2.- El programa de afiliaci&oacute;n proporciona al interesado diversas ventajas 
entre las que se incluyen la posibilidad de acceder a un panel de control personalizado, 
descuentos especiales seg&uacute;n n&uacute;mero de registros, formulas de prepago 
y la opci&oacute;n de incluir elementos promocionales y v&iacute;nculos en sus 
propias productos de internet que dirijan al cliente a nombremania.com, con el 
fin de registrar dominios en internet.
3.- El afiliado NO podr&aacute; variar el contenido y/o forma de los elementos 
promocionales que NombreMania ponga a su disposici&oacute;n a trav&eacute;s de 
sus p&aacute;ginas web.
4.- El afiliado se compromete a no utilizar el nombre ni los elementos promocionales 
aportados por Nombremania para dirigir a sus clientes a cualquier otro producto, 
p&aacute;gina web o empresa. Este hecho supondr&aacute; la autom&aacute;tica rescisi&oacute;n 
del acuerdo y la posible reclamaci&oacute;n de da&ntilde;os por los perjuicios 
que esto haya supuesto a NombreMania
5.- Cuando un cliente final acceda a la web de NombreMania.com desde las p&aacute;ginas 
del afiliado, NombreMania se compromete a establecer todos los medios necesarios 
para contabilizar este acceso en favor del afiliado en aquellos casos en que el 
proceso acabe en un registro. Todas las solicitudes que acaben en pedidos terminados 
y abonados proporcionar&aacute;n cr&eacute;ditos a favor del afiliado seg&uacute;n 
las condiciones vigentes por Nombremania en ese momento.
6.- Sin perjuicio de variaci&oacute;n en las promociones vigentes en ese momento, 
como formula b&aacute;sica de compensaci&oacute;n, el afiliado obtendr&aacute; 
el derecho al registro de un dominio b&aacute;sico (exclusivamente tipo .com, 
.net, .org) por un a&ntilde;o, por cada 10 registros equivalentes a un a&ntilde;o 
que los clientes suministrados por &eacute;l, hayan realizado y abonado. Solo 
se contabilizar&aacute;n como validos aquellos registros totalmente abonados y 
siempre que no se produzca una cancelaci&oacute;n o devoluci&oacute;n posterior 
del pago por parte del cliente. Los 10 primeros dominios/a&ntilde;os remitidos 
por el cliente NO ser&aacute;n computables para estos calculos, abonandose al 
afiliado dicho margen a partir del vigesimo.
7.- S&oacute;lo son comisionables las nuevas altas y/o los traslados en su primer
a&ntilde;o. Las renovaciones no dan derecho a comisi&oacute;n.
8.- NombreMania se reserva el derecho de cancelar cualquier cuenta de afiliado 
sin previo aviso, no teniendo derecho el afiliado a ning&uacute;n tipo de indemnizaci&oacute;n 
por este hecho.</textarea>
                            </font></p>
                          <p> <font face="Verdana, Arial, Helvetica, sans-serif" size="1"> 
                            <input type="checkbox" name="aceptacondiciones" value="checkbox">
                            <b>Acepto las condiciones de afiliaci&oacute;n</b></font></p>
                        </td>
                      </tr>
                      <tr> 
                        <td colspan="3"> 
