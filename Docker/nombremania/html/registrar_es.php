...
<iframe src='http://linux.alsur.es/phpads/adframe.php?what=zone:5&target=new&refresh=25' framespacing='0' frameborder='no' scrolling='no' width='180' height='150'><script language='JavaScript' src='http://linux.alsur.es/phpads/adjs.php?what=zone:5&target=new&withText=0'></script><noscript><a href='http://linux.alsur.es/phpads/adclick.php' target='new'><img src='http://linux.alsur.es/phpads/adview.php?what=zone:5&target=new&withText=0' border='0'></a></noscript></iframe><!-- #EndLibraryItem --><p align="center">&nbsp;</p>
          ...
          <td width="520" valign="top">
            <table border=0 cellpadding="2">
              <tr> 
                <td colspan="3"><img src="/imagenes/dominioses.gif" width="111" height="15"></td>
              </tr>
              <tr> 
                <td colspan="3" bgcolor="#FFFFFF" class="body_10"> 
                  <p><font face="Verdana, Arial, Helvetica, sans-serif" size="1">Los 
                    dominios &quot;es&quot; son los dominios asignados por el 
                    organismo nacional espa&ntilde;ol, actualmente el ESNIC (<a href="http://www.nic.es" target="nueva">www.nic.es</a>).</font></p>
                  <p><font face="Verdana, Arial, Helvetica, sans-serif" size="1"><b> 
                    Los requisitos para formalizarlos son bastantes estrictos</b> 
                    y entre ellos destacamos:</font></p>
                  <ul>
                    <li><font face="Verdana, Arial, Helvetica, sans-serif" size="1"> 
                      los dominios solicitados deben coincidir &quot;de forma 
                      exacta&quot;con el <b>nombre de la empresa o una marca formalmente 
                      registrada</b>. </font></li>
                    <li><font face="Verdana, Arial, Helvetica, sans-serif" size="1"><b>se 
                      pagan por a&ntilde;os naturales</b> (del 1 de Enero al 31 
                      de Diciembre) independientemente de cuando se registren. 
                      </font></li>
                    <li><font face="Verdana, Arial, Helvetica, sans-serif" size="1">las 
                      DNS asociadas <b>deben estar activas antes</b> de poder 
                      proceder con el registro.</font></li>
                  </ul>
                  <p>Puedes consultar las tarifas de registro en nuestra secci&oacute;n 
                    de <a href="/precios.php">precios</a>.</p>
                </td>
              </tr>
              <tr> 
            ...
            <span class="body_9"><br>
            La formalizaci&oacute;n de cualquier registro en Nombremania.com supone 
