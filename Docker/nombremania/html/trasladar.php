...
<meta http-equiv="Content-type" content="text/html; charset=UTF-8">
<title>Traslada tu dominio a NombreMania</title>
<!-- #EndEditable --> 
      ...
      <table width="710" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td rowspan="3" valign="top"> 
            <p align="center"><br>
              <img src="/imagenes/dominios.gif" width="125" height="60"><br>
              <br>
              <br>
            </p><!-- #BeginLibraryItem "/Library/Banner180.lbi" --><!--banner NMcaja de phpads -->
          ...
          <td width="520" valign="top"> <img src="/imagenes/multiligue.gif" width="125" height="60" align="right" vspace="15"> 
            <table border="0" cellpadding="0" cellspacing="0" width="360">
              ...
              <tr> 
                ...
                <td> 
                  <form name="simple" method="post" action="/dominator.php">
                    <table border='0' cellspacing='0' cellpadding='2' align="left" width="100%">
                      <tr> 
                        <td valign='middle' align="left"> 
                          ...
                          <input type="image" src='imagenes/continuar.gif' align='middle' border='0' name='buscar' width="85" height="26">
                        </td>
                      </tr>
                      <tr> 
                        <td class="td_form_titulo" align="left"> 
                          <P>Introduce el nombre sin www. <br>
                            Puedes usar e&ntilde;es, tildes.<br>
                            No olvides la extensi&oacute;n<b> .com .net .org .tv. 
                            &oacute; .cc</b></P>
                          <P><FONT color="#000000">Antes de proceder, por favor 
                            consulta los <A href="/ayuda/traslado_dominios.html" target="new">MOTIVOS 
                            HABITUALES</A> para el rechazo de traslados y consulta 
                            el nuestro <A href="/whois" target="new">whois</A> 
                            para conocer el estado del dominio a trasladar.</FONT></P>
                        </td>
                      </tr>
                    </table>
                  </form>
        ...
        <tr> 
          ...
          <td width="520" valign="top"> 
            <table border=0 cellpadding="1">
              <tr> 
                <td colspan="3" height="20"><img src="/imagenes/dominiostraslado.gif" width="221" height="21"></td>
              </tr>
              <tr> 
                <td colspan="3" bgcolor="#FFFFFF" class="body_10"> 
                  <p><font face="Verdana, Arial, Helvetica, sans-serif" size="1">Para 
                    trasladar dominios (solo com, net, org), NO ES NECESARIO ESPERAR 
                    a que caduque el periodo pagado con el registrador actual. 
                    Todo el tiempo que ya tengas abonado se sigue conservando. 
                    Es decir, si actualmente tu dominio caduca el 2 de Diciembre, 
                    al trasladarlo a NombreMan&iacute;a quedar&aacute; abonado 
                    a partir de ese d&iacute;a por el periodo de a&ntilde;os que 
                    solicites (de 1 a 10).</font></p>
                  <p><font face="Verdana, Arial, Helvetica, sans-serif" size="1">Con 
                    el traslado te beneficiaras de un ahorro considerable en a&ntilde;os 
                    sucesivos y de todas las ventajas de nuestro sistema de administraci&oacute;n. 
                    Recuerda tambi&eacute;n que si ya tienes dominios registrados 
                    con NombreMania, podr&aacute;s utilizar tu perfil de registros 
                    anteriores para que estos dominios queden incluidos en tu 
                    panel de control.</font></p>
                  <p><font face="Verdana, Arial, Helvetica, sans-serif" size="1">Antes 
                    de proceder a un traslado ten en cuenta lo siguiente:</font></p>
                  <blockquote> 
                    <p><font face="Verdana, Arial, Helvetica, sans-serif" size="1">1. 
                      Para validar el traslado de un dominio, se remitir&aacute; 
                      un email al actual contacto administrativo del dominio con 
                      unas instrucciones para confirmar dicho traslado. Confirma 
                      que el email correspondiente, asociado al dominio que quieres 
                      trasladar se encuentra operativo antes de proceder. De otro 
                      modo la petici&oacute;n quedar&aacute; a&uacute;tomaticamente 
                      anulada.</font></p>
                    <p><font face="Verdana, Arial, Helvetica, sans-serif" size="1">2. 
                      Los dominios trasladados <b>conservar&aacute;n los valores 
                      de DNS del registro actual</b> antes del traslado, si deseas 
                      cambiarlos, deberas esperar a que el traslado sea efectivo 
                      y hacerlo desde tu panel de control.</font></p>
                  </blockquote>
                  <p><font face="Verdana, Arial, Helvetica, sans-serif" size="1">Los 
                    precios de traslado son id&eacute;nticos a los de registro, 
                    aunque no podr&aacute;s adquirir registros tipo PRO, hasta 
                    que el traslado se haya completado integramente.</font></p>
                </td>
              </tr>
              <tr> 
                <td colspan="3"> 
                  <hr width=100% size="1" color="orange" noshade>
                  <img src="/imagenes/titular_trasladomultiple.gif" width="180" height="32"><br>
                  Traslada hasta 50 dominios en una sola solicitud. Todos los 
                  dominios quedar&aacute;n asociados al mismo perfil, pudiendo 
                  despu&eacute;s administrarlos de forma conjunta. Mas informaci&oacute;n 
                  en <a href="mailto:soporte@nombremania.com">soporte@nombremania.com</a><br>
                  <br>
                  <table border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr> 
                      ...
                      <td> 
                        <form name="multiple" method="post" action="/registro/index.php">
                          <table border='0' cellspacing='0' cellpadding='2' align="left" width="100%">
                            <tr> 
                              <td valign='middle' align="left"> 
                                <input type="hidden" name="affiliate_id" value="<? echo $affiliate_id?>">
                                <input type="hidden" name="action" value="bulk_transfer">
                                <textarea name="domain" cols="35" rows="5" ></textarea>
                                <input type="image" src='imagenes/continuar.gif' align='middle' border='0' name='buscar' width="85" height="26">
                              </td>
                            </tr>
                            <tr> 
                              <td class="td_form_titulo" align="left"> Introduce 
                                el nombre sin www. Puedes usar e&ntilde;es, tildes.<br>
                                No olvides la extensi&oacute;n<b> .com .net .org 
                                .tv. .eu &oacute; .cc</b></td>
                            </tr>
                          </table>
                        </form>
                      </td>
