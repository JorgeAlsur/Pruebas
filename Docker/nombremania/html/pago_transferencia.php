...
if (isset($email)){
$texto = "
Se ha realizado una transferencia a nombre de: \n
$titular_c_emisora \n 
para abonar los siguientes registros \n
$dominios_registrados \n
numero de orden de la transferencia = $numero_orden\n
importe = $importe\n
email del cliente: $email\n
nombre = $name\n\n";
$destino="registros@nombremania.com";
mail($destino,"Aviso de pago por transferencia",$texto,"From: $email");
$gracias="GRACIAS POR EL AVISO, en breve tendr&aacute; noticias nuestras";
}
else {
$gracias="";
}
      ...
      <table width="710" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td width="180" valign="top"><br>
            <br><!-- #BeginLibraryItem "/Library/banner180_ 2x.lbi" --><!--banner NMcajadoble de phpads -->
<iframe src='http://linux.alsur.es/phpads/adframe.php?what=zone:5&target=new&refresh=25' framespacing='0' frameborder='no' scrolling='no' width='180' height='150'><script language='JavaScript' src='http://linux.alsur.es/phpads/adjs.php?what=zone:5&target=new&withText=0'></script><noscript><a href='http://linux.alsur.es/phpads/adclick.php' target='new'><img src='http://linux.alsur.es/phpads/adview.php?what=zone:5&target=new&withText=0' border='0'></a></noscript></iframe><!-- #EndLibraryItem --></td>
          ...
          <td width="520" valign="top"><br>
              <img src="/imagenes/titulo_pagotrans.gif" width="520" height="32"><br>
              <p class="error">
              <?=$gracias;?>
          </p>
            <form method="post" action="<?=$PHPSELF; ?>" name="form1" onSubmit="YY_checkform('form1','name','#q','0','El nombre es requerido.','email','#q','2','El email es requerido.','numero_orden','#q','0','El numero de orden es requerido.','titular_c_emisora','#q','0','El titular de la cuenta emisora es requerido.','importe','#q','0','Por favor introduzca el importe.','name','#q','0','El nombre es requerido.','email','#q','2','El email es requerido.','numero_orden','#q','0','El numero de orden es requerido.','titular_c_emisora','#q','0','El titular de la cuenta emisora es requerido.','importe','#q','0','Por favor introduzca el importe.','name','#q','0','El nombre es requerido.','email','#q','2','El email es requerido.','numero_orden','#q','0','El numero de orden es requerido.','titular_c_emisora','#q','0','El titular de la cuenta emisora es requerido.','importe','#q','0','Por favor introduzca el importe.','name','#q','0','El nombre es requerido.','email','#q','2','El email es requerido.','numero_orden','#q','0','El numero de orden es requerido.','titular_c_emisora','#q','0','El titular de la cuenta emisora es requerido.','importe','#q','0','Por favor introduzca el importe.');return document.MM_returnValue" >
              <center>
              </center>
              <table border=0 width=518 cellpadding="2" cellspacing="1">
                <tr align="left"> 
                  <td colspan=2 bgcolor="#003366" class="titu_secciones"> <b>Datos 
                    del Titular</b><font face="Verdana, Arial, Helvetica, sans-serif" size="1">&nbsp; 
                    </font></td>
                </tr>
                <tr> 
                  <td align=right bgcolor="#FFCC00" class="td_form_titulo"><font face="Verdana, Arial, Helvetica, sans-serif" size="1"><b>Nombre:</b></font></td>
                  <td class="td_form_valor"><font face="Verdana, Arial, Helvetica, sans-serif" size="1"> 
                    <input name="name" size=35 value="">
                    </font></td>
                </tr>
                <tr> 
                  <td align=right bgcolor="#FFCC00" class="td_form_titulo"><font face="Verdana, Arial, Helvetica, sans-serif" size="1"><b>Email:</b></font></td>
                  <td class="td_form_valor"><font face="Verdana, Arial, Helvetica, sans-serif" size="1"> 
                    <input name="email" size=30 value="">
                    </font></td>
                </tr>
                <tr> 
                  <td align=right bgcolor="#FFCC00" class="td_form_titulo"><font face="Verdana, Arial, Helvetica, sans-serif" size="1"><b>Dominio/s 
                    registrado/s:</b></font></td>
                  <td class="td_form_valor"><font face="Verdana, Arial, Helvetica, sans-serif" size="1"> 
                    <textarea name="dominios_registrados" cols="33" wrap="VIRTUAL" rows="3"></textarea>
                    </font></td>
                </tr>
                <tr> 
                  <td align=right bgcolor="#FFCC00" class="td_form_titulo"><font face="Verdana, Arial, Helvetica, sans-serif" size="1"><b>N 
                    de orden:</b></font></td>
                  <td class="td_form_valor"><font face="Verdana, Arial, Helvetica, sans-serif" size="1"> 
                    <input name="numero_orden" size=10 value="">
                    </font></td>
                </tr>
                <tr> 
                  <td align=right bgcolor="#FFCC00" class="td_form_titulo"><font face="Verdana, Arial, Helvetica, sans-serif" size="1"><b>Titular 
                    cuenta emisora:</b></font></td>
                  <td class="td_form_valor"><font face="Verdana, Arial, Helvetica, sans-serif" size="1"> 
                    <input name="titular_c_emisora" size=35 value="">
                    </font></td>
                </tr>
                <tr> 
                  <td align=right bgcolor="#FFCC00" class="td_form_titulo"><font face="Verdana, Arial, Helvetica, sans-serif" size="1"><b><font color="#FF0000">Importe 
                    total:</font></b></font></td>
                  <td class="td_form_valor"><font face="Verdana, Arial, Helvetica, sans-serif" size="1"> 
                    <input name="importe" size=15 value="">
                    </font></td>
                </tr>
                <tr> 
                  <td colspan=2 align=center><img src="/imagenes/shim.gif" width="4" height="10"></td>
                </tr>
                <tr align="right"> 
                  <td colspan=2> 
                    <input type="image" border="0" name="imageField" src="/imagenes/enviar.gif" width="61" height="26">
                  </td>
                </tr>
              </table>
            </form>
