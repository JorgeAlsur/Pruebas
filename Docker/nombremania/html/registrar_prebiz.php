  ...
  <tr> 
	...
	<!-- #BeginEditable "contenido" --> 
      <table width="710" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td width="180" valign="top"><!-- #BeginLibraryItem "/Library/menu_registro.lbi" --> 
...
<!-- #EndLibraryItem --></td>
          ...
          <td width="520" valign="top" class="body_9"> 
            <p><img src="/imagenes/titular_prebiz.gif" width="520" height="32" class="input_radios"><br>
              <font face="Verdana, Arial, Helvetica, sans-serif" size="1" color="#CC0000"><span class="body_11"><font color="#000099">Una 
              nueva extensi&oacute;n... una nueva oportunidad</font></span></font><font face="Verdana, Arial, Helvetica, sans-serif" size="1"><br>
              La extensi&oacute;n&quot;.biz&quot; es una de las nuevas introducidas 
              este a&ntilde;o por la ICANN y una de las de muy pr&oacute;xima 
              funcionalidad (previsto su lanzamiento en el ultimo trimestre de 
              2001). Est&aacute;n dedicados &uacute;nica y exclusivamente para 
              actividades comerciales y de negocios, Se prev&eacute; alcancen 
              tanta importancia como los &quot;.com&quot;.</font></p>
            <p><font face="Verdana, Arial, Helvetica, sans-serif" size="1" color="#CC0000"><span class="body_11"><font color="#000099">Fase 
              de Preregistro</font></span></font><font face="Verdana, Arial, Helvetica, sans-serif" size="1"><br>
              <font size="2"><b><font color="#990000">Dada la cercan&iacute;a 
              de la fase de registro en tiempo real, que integraremos en breve, 
              hemos cerrado el preregistro anticipado de dominios .biz.</font></b></font></font></p>
            <p><font size="2"><b><font face="Verdana, Arial, Helvetica, sans-serif">Aquellos 
              clientes de NombreMan&iacute;a que tengan especial inter&eacute;s 
              en formalizar un preregistro pueden contactar con registros@nombremania.com 
              y les enviaremos instrucciones de como proceder.</font></b></font></p>
            <hr>
            <p><font face="Verdana, Arial, Helvetica, sans-serif" size="1" color="#CC0000"><span class="body_11"><font color="#000099">Fases 
              del lanzamiento</font></span></font><font face="Verdana, Arial, Helvetica, sans-serif" size="1"><br>
              </font><br>
              El registro de dominios .biz ha comenzado y se desarrolla durante 
              este a&ntilde;o en las siguientes etapas:<br>
            </p>
            <ul>
              <li><b>FASE 1. Para titulares de marcas registradas:</b> se pueden 
                inscribir en un servicio de alertas rellenando un formulario para 
                que cuando alguien intente registrarla como un nombre de dominio, 
                el servicio le avise de ese hecho. Fecha l&iacute;mite: 6 de Agosto 
                de 2001. CERRADO.<br>
              </li>
            </ul>
            <ul>
              <li><b>FASE 2. Pre-registro de dominios:</b> en este per&iacute;odo, 
                que va desde el 6 de Agosto al 26 de septiembre de 2001, las entidades 
                registradoras acreditadas, presentar&aacute;n a la entidad .biz 
                los pre-registros de todos aquellos que deseen registrar dominios 
                .biz. Luego esta entidad procesar&aacute; dichas solicitudes y 
                en el caso de que hubiera otro inscrito con el mismo dominio de 
                la marca de su empresa se har&aacute;n las notificaciones correspondientes 
                para que este desista o no de la solicitud. En caso de no desistir, 
                entre el 26 y el 30 de Septiembre, dicha entidad seleccionar&aacute; 
                aleatoriamente un solicitante de todos los que hayan inscrito 
                el mismo nombre de dominio, mientras tanto el dominio de la otra 
                parte quedar&aacute; congelado. Se otorgar&aacute; un plazo de 
                20 d&iacute;as para que las partes involucradas lleguen a acuerdo, 
                en caso de no lograrlo se activa el procedimiento de resoluci&oacute;n 
                de controversias denominado STOP (Starup Trademark Opposition 
                Policy).<br>
              </li>
            </ul>
            <ul>
              <li><b>FASE 3. Registro:</b> Se registran los dominios adjudicados 
                de la misma manera que se hizo con los &quot;.com&quot;, &quot;.net&quot; 
                y &quot;.org&quot;, en torno al final de Octubre de 2001.</li>
            </ul>
      ...
      <br>
      <img src="/imagenes/base2/spacer.gif" width="10" height="8" border="0"><!-- #EndEditable --> </td>
