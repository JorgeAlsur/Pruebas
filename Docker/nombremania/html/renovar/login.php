...
if(isset($_GET['op']))
{
	...
	header("Location: ".$server_url."/renovar/login.php");
	exit;
}

if(isset($_COOKIE['REGISTRANT_LIVE_KEY']) && $_COOKIE['REGISTRANT_LIVE_KEY']!='')
{
	...
	header("Location: ".$server_url."/renovar/acceso.php?action=login&c=manage&reg=".$_COOKIE['REGISTRANT_LIVE_KEY']);
	exit;
}
?>
<HTML><!-- #BeginTemplate "/Templates/nm2_base_ssl.dwt" --><!-- DW6 -->
<HEAD>
<meta http-equiv="Content-type" content="text/html; charset=UTF-8">
<!-- #BeginEditable "doctitle" --> 
<title>Renovacion de servicios</title>
<!-- #EndEditable -->
...
<table border="0" cellpadding="0" cellspacing="0" width="740" align="center">
  ...
  <tr> 
    <td rowspan="3" colspan="4"><a href="http://www.nombremania.com" onMouseOut="MM_swapImgRestore()"  onMouseOver="MM_swapImage('simbolo','','/imagenes/base3/simbolo_f2.gif','logo','','/imagenes/base3/logo_f2.gif',1);" ><img name="logo" src="/imagenes/base3/logo.gif" width="149" height="27" border="0" alt="NombreMania - registro de dominios"></a></td>
  ...
  <tr> 
    ...
    <td><a href="http://www.nombremania.com/alquilar.php" onMouseOut="MM_swapImgRestore()"  onMouseOver="MM_swapImage('alquiler','','/imagenes/base3/alquiler_f2.gif',1);" ><img name="alquiler" src="/imagenes/base3/alquiler.gif" width="70" height="15" border="0" alt="Los dominios tambon se alquilan"></a></td>
    <td><a href="http://www.nombremania.com/demos/index.html" onMouseOut="MM_swapImgRestore()"  onMouseOver="MM_swapImage('demo','','/imagenes/base3/demo_f2.gif',1);" ><img name="demo" src="/imagenes/base3/demo.gif" width="56" height="15" border="0" alt="Demos del sistema"></a></td>
  ...
  <tr> 
    ...
    <td rowspan="2" colspan="4" bgcolor="#FFFFFF"><a href="http://www.nombremania.com/precios.php" onMouseOut="MM_swapImgRestore()"  onMouseOver="MM_swapImage('precios','','/imagenes/base3/precios_f2.gif',1);" ><img name="precios" src="/imagenes/base3/precios.gif" width="58" height="16" border="0" alt="Precios y tarifas"></a></td>
    ...
    <td rowspan="2" bgcolor="#FFFFFF"><a href="http://www.nombremania.com/ayuda/index.html" onMouseOut="MM_swapImgRestore()"  onMouseOver="MM_swapImage('ayuda','','/imagenes/base3/ayuda_f2.gif',1);" ><img name="ayuda" src="/imagenes/base3/ayuda.gif" width="55" height="16" border="0" alt="Ayuda y documentaci n"></a></td>
    <td rowspan="2" colspan="2" bgcolor="#FFFFFF"><a href="http://www.nombremania.com/whois/index.php" onMouseOut="MM_swapImgRestore()"  onMouseOver="MM_swapImage('whois','','/imagenes/base3/whois_f2.gif',1);" ><img name="whois" src="/imagenes/base3/whois.gif" width="43" height="16" border="0" alt="Consulta nuestro Whois"></a></td>
    ...
    <td rowspan="2" colspan="8" bgcolor="#FFFFFF" align="right" class="body_10">&nbsp;</td>
...
<table bgcolor="#ffcc00" border="0" cellpadding="0" cellspacing="0" width="740" align="center">
  ...
  <tr> 
    ...
    <td colspan="23" height="400" bgcolor="#FFFFFF" valign="top"><!-- #BeginEditable "contenido" --> 
      <br>
      <table width="710" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td width="180" valign="top" class="input_radios" height="261">&nbsp;</td>
          <td width="10" valign="top" height="261"><img src="/nm/imagenes/base2/spacer.gif" width="10" height="8" border="0"></td>
          <td width="520" valign="top" height="261"> 
            <form method=post action="acceso.php">
						<input type="hidden" name="c" value="no">
              <center>
                <table border=0 cellpadding=4 cellspacing=0 width="100%">
                  <tr> 
                    <td align=left class="td_form_titulo"><B>RENOVACI&Oacute;N 
                      DE DOMINIOS</B></td>
                  <tr> 
                    <td align=left> 
                      <p>Desde aqu&iacute; podr&aacute;s renovar tu dominio o 
                        los servicios adicionales contratados para el mismo. Desde 
                        tu panel de control de dominios tienes tambi&eacute;n 
                        un acceso directo, adem&aacute;s de la fecha exacta de 
                        vencimiento.</p>
                      <p>Para recuperar tus datos introduce primero los datos 
                        del dominio y acceso:<br>
                      </p>
                      <table border="0" cellpadding="0" cellspacing="0" align="left">
                        <tr> 
                          <td width="9"><img name="izs" src="/nm/imagenes/marco/izs.gif" width="9" height="9" border="0"></td>
                          <td background="/nm/imagenes/marco/mea.gif"><img name="mea" src="/nm/imagenes/marco/mea.gif" width="82" height="9" border="0"></td>
                          <td width="9"><img name="des" src="/nm/imagenes/marco/des.gif" width="9" height="9" border="0"></td>
                        </tr>
                        <tr> 
                          <td background="/nm/imagenes/marco/izm.gif" width="9"><img name="izm" src="/nm/imagenes/marco/izm.gif" width="9" height="43" border="0"></td>
                          <td> 
                            <table border=0 cellpadding=1 cellspacing=1 width="100%">
                              <tr> 
                                <td align="right" class="td_form_titulo"> 
                                  <div align="right"><font face="verdana, arial" size=1><strong> 
                                    <input type=hidden name=action value="login">
                                    Dominio:</strong></font></div>
                                </td>
                                <td class="td_form_valor"> 
                                  <input type=text name=reg_domain value="" size=26>
                                </td>
                              </tr>
                              <tr> 
                                <td align="right" class="td_form_titulo"> 
                                  <div align="right"><font face="verdana, arial" size=1><strong> 
                                    Nombre de usuario:</strong></font></div>
                                </td>
                                <td class="td_form_valor"> 
                                  <input type=text name=reg_username value="" size=15>
                                </td>
                              </tr>
                              <tr> 
                                <td align="right" class="td_form_titulo"> 
                                  <div align="right"><font face="verdana, arial" size=1><strong> 
                                    Contrase&ntilde;a:</strong></font></div>
                                </td>
                                <td class="td_form_valor"> 
                                  <input type=password name=reg_password value="" size=15>
                                </td>
                              </tr>
                              <tr> 
                                <td colspan=2 height="20" class="body_9"> <font size="1" face="Verdana, Arial, Helvetica, sans-serif" class="body_9">* 
                                  El nombre de usuario y la contrase&ntilde;a 
                                  son sensibles a may&uacute;sculas y min&uacute;sculas.</font></td>
                              </tr>
                              <tr align="right"> 
                                <td colspan=2 height="20" class="body_9"> 
                                  <input type="image" border="0" name="imageField" src="/nm/imagenes/continuar.gif">
                                </td>
                              </tr>
                            </table>
                          </td>
                          <td background="/nm/imagenes/marco/dem.gif" width="9"><img name="dem" src="/nm/imagenes/marco/dem.gif" width="9" height="43" border="0"></td>
                        </tr>
                        <tr> 
                          <td width="9"><img name="izb" src="/nm/imagenes/marco/izb.gif" width="9" height="9" border="0"></td>
                          <td background="/nm/imagenes/marco/meb.gif"><img name="meb" src="/nm/imagenes/marco/meb.gif" width="82" height="9" border="0"></td>
                          <td width="9"><img name="deb" src="/nm/imagenes/marco/deb.gif" width="9" height="9" border="0"></td>
                        </tr>
                      </table>
                    </td>
                  </tr>
  ...
  <tr> 
    <td colspan="23" bgcolor="#FFFFFF" valign="bottom"><!-- #BeginEditable "Pie de pgina" -->
