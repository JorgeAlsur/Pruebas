...
<iframe src='http://linux.alsur.es/phpads/adframe.php?what=zone:5&target=new&refresh=25' framespacing='0' frameborder='no' scrolling='no' width='180' height='150'><script language='JavaScript' src='http://linux.alsur.es/phpads/adjs.php?what=zone:5&target=new&withText=0'></script><noscript><a href='http://linux.alsur.es/phpads/adclick.php' target='new'><img src='http://linux.alsur.es/phpads/adview.php?what=zone:5&target=new&withText=0' border='0'></a></noscript></iframe><!-- #EndLibraryItem --></td>
          ...
          <td width="520" valign="top"> 
            <table border=0 align="left" cellpadding="3">
              <tr> 
                <td colspan="3" height="15"><img src="/imagenes/titular_administracion.gif" width="501" height="32"></td>
              </tr>
              <tr> 
                <td colspan="3"><font size=+1 class="body_10">Bienvenido a la 
                  zona de administraci&oacute;n de NombreMan&iacute;a.</font></td>
              </tr>
              <tr> 
                <td colspan="3"> 
              ...
              <tr> 
                <td colspan="3" height="20"> 
                  <p><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><b><a href="https://ssl.alsur.es/cgi-bin/nm/managesp.cgi">Gesti&oacute;n
                    de dominios</a></b></font></p>
                </td>
              </tr>
              <tr> 
                <td colspan="3" bgcolor="#FFFFFF"> 
                  <p><font face="Verdana, Arial, Helvetica, sans-serif"><font face="Verdana, Arial, Helvetica, sans-serif" size="1" class="body_10">Gesti&oacute;n 
                    de los dominios asociados a tu perfil... contactos, DNS, etc.</font></font></p>
                </td>
              </tr>
              <tr> 
                <td colspan="3"> 
              ...
              <tr> 
                <td colspan="3" height="20"><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><b><a href="/clientes/login.php">Administraci&oacute;n 
                  de tu cuenta de cliente</a></b></font></td>
              </tr>
              <tr> 
                <td colspan="3" bgcolor="#FFFFFF"><font face="Verdana, Arial, Helvetica, sans-serif" size="1" class="body_10">Control 
                  de saldos, pagos, codigos HTML del programa de afiliados, nuevos 
                  registros y traslados...</font></td>
              </tr>
            </table>
          </td>
        </tr>
