...
//					 $conn->debug=1;
	...
	//					print mysql_error();
           ...
           $texto="Estimado Usuario : 
            ...
            mail($datos["email"],"nombremania.com -Acceso a oferta","$texto","From: registros@nombremania.com");
           }
           }
           }
        ...
        ?>
              <tr> 
                <td colspan="3" class="titu_pags">Oferta -1 Euro</td>
              </tr>
              <tr> 
                <td colspan="3" class="body_10">
                  <p><br>
                    Para aplicarte esta oferta es imprescindible que rellenes 
                    el siguiente cuestionario. Solo los campos en rojo son requeridos, 
                    pero te <b>estariamos muy agradecidos</b>, si rellenaras el 
                    resto con datos verdaderos que nos ayudan fundamentalmente 
                    a mejorar el servicio a clientes.</p>
                  <p>Recibiras en tu buzon el enlace valido para aplicarte la 
                    oferta mientras est&eacute; activa. A cada nuevo dominio que 
                    registres<b> se le descontar&aacute; UN EURO sobre el PVP.<br>
                    </b> </p>
                </td>
              </tr>
              <tr> 
              ...
              <tr> 
                <td colspan="3"> 
                  <form method="post" action="<?=$PHPSELF?>" name="cuestionariouneuro" onSubmit="YY_checkform('document.cuestionariouneuro','aceptacondiciones','q','1','Debe aceptar las condiciones de alta','f_usuario','#q','0','Debe incluir un nombre de usuario','f_clave','#q','0','Field \"f_clave\" is not valid.','f_direccion','8','1','La direccin no es valida');return document.MM_returnValue">
                    <table border="0" cellspacing="2" cellpadding="2" align="center" width="100%">
                      ...
                      <tr> 
                        <td bgcolor="#FFFFFF" class="td_form_titulo"> 
                          <div align="right"><font face="Verdana, Arial, Helvetica, sans-serif" size="1" color="#990000"><b>Provincia:</b></font></div>
                        </td>
                        <td colspan="2" bgcolor="#FFCC00" class="td_form_valor"><font face="Verdana, Arial, Helvetica, sans-serif" size="1"> 
...
Esta oferta es valida al menos hasta el 16 de Noviembre de 2001, pudiendo quedar anulada en cualquier momento posterior sin previo aviso. 
La oferta consistir en el descuento de un euro por cada nuevo dominio registrado independientemente del nmero de aos que se soliciten. Esta oferta no es aplicable a traslados.</textarea>
                            </font></p>
                          <p> <font face="Verdana, Arial, Helvetica, sans-serif" size="1"> 
              ...
              ?>
                  <table border=0 width="520" align="left" cellpadding="3">
                    <tr> 
                      <td colspan="3" class="titu_pags">Gracias</td>
                    </tr>
                    <tr> 
                      <td colspan="3" class="body_10"> 
                        ...
                        <p><font size=2 face="Verdana, Arial, Helvetica, sans-serif" color="#000000"> 
                          En unos instantes recibir&aacute; un email con la URL 
                          de acceso correspondiente.</font></p>
                        <p>&nbsp;</p>
                        <p>&nbsp;</p>
                      </td>
                    </tr>
