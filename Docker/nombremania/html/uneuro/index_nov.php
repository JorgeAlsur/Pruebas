  ...
  <tr> 
	...
	<!-- #BeginEditable "contenido" --> 
      ...
      <table width="710" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td width="180" valign="top"><a href="http://www.regaleundominio.com"><img src="/imagenes/regalo.gif" width="180" height="100" border="0"></a> 
          </td>
          <td width="10" valign="top"><img src="/imagenes/base2/spacer.gif" width="10" height="8" border="0"></td>
          <td width="510" valign="top"> 
            <table border=0 cellpadding="3" width="100%" height="320">
              <?
          $fatal=0;
          $error=array();
          $errores="";
...
//					 $conn->debug=1;
	...
	//					print mysql_error();
        ...
        ?>
              ...
              <tr> 
                <td colspan="3"> 
                  <form method="post" action="<?=$PHPSELF?>" name="cuestionariouneuro"f_clave\" is not valid.','f_direccion','8','1','La direccin no es valida');return document.MM_returnValue">
...
La oferta consistir&aacute; en el descuento de un euro por cada nuevo dominio registrado independientemente del n&uacute;mero de a&ntilde;os que se soliciten. Esta oferta no es aplicable a traslados.</textarea>
              ...
              ?>
                  <table border=0 width="520" align="left" cellpadding="3" height="320">
                    <tr> 
                      <td colspan="3" class="titu_pags">Gracias</td>
                    </tr>
                    <tr> 
                      <td colspan="3" class="body_10" valign="top"> 
