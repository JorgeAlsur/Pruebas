      ...
      <table width="710" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td width="180" valign="top">
            <p><!-- #BeginLibraryItem "/Library/menu_registro.lbi" --> 
...
<!-- #EndLibraryItem --><br><!-- #BeginLibraryItem "/Library/banner180_ 2x.lbi" --><!--banner NMcajadoble de phpads -->
<iframe src='http://linux.alsur.es/phpads/adframe.php?what=zone:5&target=new&refresh=25' framespacing='0' frameborder='no' scrolling='no' width='180' height='150'><script language='JavaScript' src='http://linux.alsur.es/phpads/adjs.php?what=zone:5&target=new&withText=0'></script><noscript><a href='http://linux.alsur.es/phpads/adclick.php' target='new'><img src='http://linux.alsur.es/phpads/adview.php?what=zone:5&target=new&withText=0' border='0'></a></noscript></iframe><!-- #EndLibraryItem --><p align="center">&nbsp;</p>
          </td>
          <td width="10" valign="top"><img src="/imagenes/base2/spacer.gif" width="10" height="8" border="0"></td>
          <td width="520" valign="top">
            <p><img src="/imagenes/titular_avanzado.gif" width="520" height="32"><br>
              <b class="body_11"><br>
              <font color="#000099">&iquest;No encuentras tu nombre ideal?</font><br>
              </b>Ahora nuestro sistema de b&uacute;squeda inteligente te ayuda 
              con la tarea. Introduce <b>dos palabras</b> pr&oacute;ximas al dominio 
              que desees registrar o que definan el servicio o producto, y podr&aacute;s 
              comprobar todas sus combinaciones en una sola consulta. Tambi&eacute;n 
              puedes dejar que te sugiramos combinaciones adicionales con diversos 
              prefijos y sufijos.</p>
            <form name='formulario' method='post' action='/registro/index.php' >
              <table border="0" cellpadding="0" cellspacing="0">
                <tr> 
                  ...
                  <td background="/imagenes/marco/mea.gif" colspan="2"><img name="mea" src="/imagenes/marco/mea.gif" width="82" height="9" border="0"></td>
...
<!-- Begin
   ...
   function checkSubmit() {
      ...
      {
      submitcount++;
      MM_swapImage('procesando','','/imagenes/procesando.gif',1);
      return true;
     }
      else
      {
...
//  End -->
                    ...
                    <input type="hidden" name="action" value="lookup_avanzado">
                    <input type='text' name='palabra1' size='19' maxlength=40>
                    <input type='text' name='palabra2' size='19' maxlength=40>
                  </td>
                ...
                <tr> 
                  ...
                  <td valign='middle' align="left"> 
                    <input type="checkbox" name="sugerencia" value="1">
                    <font face="Verdana, Arial, Helvetica, sans-serif" size="1"><span class="body_10">SUGERIR 
                    OTROS NOMBRES </span></font></td>
                  <td valign='middle' align="left"><font face="Verdana, Arial, Helvetica, sans-serif" size="1"><span class="body_10"> 
                    <input  type="image" src='/imagenes/buscar.gif' align='middle' name="buscar" border='0'  onClick="return checkSubmit()">
                    <img name="procesando" src="/imagenes/base3/spacer.gif" border="0" > 
                    </span></font> </td>
                  <td background="/imagenes/marco/dem.gif"><img name="dem" src="/imagenes/marco/dem.gif" width="9" height="43" border="0"></td>
                </tr>
                <tr> 
                  <td background="/imagenes/marco/izm.gif"><img name="izm" src="/imagenes/marco/izm.gif" width="9" height="10" border="0"></td>
                  <td class="td_form_titulo" align="left" colspan="2"> Introduce 
                    dos palabras <b>sin ning&uacute;n tipo de extension</b> y 
                    sin www.</td>
                  <td background="/imagenes/marco/dem.gif"><img name="dem" src="/imagenes/marco/dem.gif" width="9" height="10" border="0"></td>
                </tr>
                <tr> 
                  <td><img name="izb" src="/imagenes/marco/izb.gif" width="9" height="9" border="0"></td>
                  <td background="/imagenes/marco/meb.gif" colspan="2"><img name="meb" src="/imagenes/marco/meb.gif" width="82" height="9" border="0"></td>
                  <td><img name="deb" src="/imagenes/marco/deb.gif" width="9" height="9" border="0"></td>
                </tr>
              </table>
            </form>
            <p><span class="body_9"><br>
              La formalizaci&oacute;n de cualquier registro en Nombremania.com 
              supone la aceptaci&oacute;n de las <a href="#" onClick="MM_openBrWindow('legales/condiciones_registro.html','cualquierotraventana','scrollbars=yes,width=500,height=300')">condiciones 
              de registro</a>.</span></p>
            <p>&nbsp;</p>
            </td>
        </tr>
      </table>
